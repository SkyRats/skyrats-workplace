...
bool pcl_msgs__msg__vertices__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pcl_msgs.msg._vertices.Vertices", full_classname_dest, 31) == 0);
  }
  pcl_msgs__msg__Vertices * ros_message = _ros_message;
  {  // vertices
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      uint32_t * dest = ros_message->vertices.data;
...
{
  /* NOTE(esteve): Call constructor of Vertices */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("pcl_msgs.msg._vertices");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Vertices");
  ...
  {  // vertices
    PyObject * field = NULL;
    field = PyObject_GetAttrString(_pymessage, "vertices");
    if (!field) {
      return NULL;
    }
    ...
    if (ros_message->vertices.size > 0) {
      // populating the array.array using the frombytes method
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      uint32_t * src = &(ros_message->vertices.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->vertices.size * sizeof(uint32_t));
      assert(data != NULL);
