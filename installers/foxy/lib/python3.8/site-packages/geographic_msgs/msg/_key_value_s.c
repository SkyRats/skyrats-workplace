...
bool geographic_msgs__msg__key_value__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("geographic_msgs.msg._key_value.KeyValue", full_classname_dest, 39) == 0);
  }
  geographic_msgs__msg__KeyValue * ros_message = _ros_message;
  {  // key
...
PyObject * geographic_msgs__msg__key_value__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("geographic_msgs.msg._key_value");
