...
bool geographic_msgs__msg__geo_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("geographic_msgs.msg._geo_point.GeoPoint", full_classname_dest, 39) == 0);
  }
  geographic_msgs__msg__GeoPoint * ros_message = _ros_message;
  {  // latitude
...
{
  /* NOTE(esteve): Call constructor of GeoPoint */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("geographic_msgs.msg._geo_point");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GeoPoint");
