...
bool geographic_msgs__msg__route_segment__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("geographic_msgs.msg._route_segment.RouteSegment", full_classname_dest, 47) == 0);
  }
  geographic_msgs__msg__RouteSegment * ros_message = _ros_message;
  {  // id
  ...
  {  // end
    ...
    if (!unique_identifier_msgs__msg__uuid__convert_from_py(field, &ros_message->end)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of RouteSegment */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("geographic_msgs.msg._route_segment");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RouteSegment");
  ...
  {  // end
    PyObject * field = NULL;
    field = unique_identifier_msgs__msg__uuid__convert_to_py(&ros_message->end);
    if (!field) {
      return NULL;
    }
    {
