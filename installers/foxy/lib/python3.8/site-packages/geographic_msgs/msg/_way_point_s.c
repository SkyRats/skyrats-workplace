...
bool geographic_msgs__msg__way_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("geographic_msgs.msg._way_point.WayPoint", full_classname_dest, 39) == 0);
  }
  geographic_msgs__msg__WayPoint * ros_message = _ros_message;
  {  // id
...
PyObject * geographic_msgs__msg__way_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("geographic_msgs.msg._way_point");
