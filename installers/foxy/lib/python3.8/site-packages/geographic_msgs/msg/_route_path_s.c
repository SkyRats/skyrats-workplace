...
bool geographic_msgs__msg__route_path__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("geographic_msgs.msg._route_path.RoutePath", full_classname_dest, 41) == 0);
  }
  geographic_msgs__msg__RoutePath * ros_message = _ros_message;
  {  // header
  ...
  {  // segments
    ...
    unique_identifier_msgs__msg__UUID * dest = ros_message->segments.data;
...
{
  /* NOTE(esteve): Call constructor of RoutePath */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("geographic_msgs.msg._route_path");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RoutePath");
