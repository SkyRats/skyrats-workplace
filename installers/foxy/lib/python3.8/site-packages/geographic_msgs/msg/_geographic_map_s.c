...
bool geographic_msgs__msg__map_feature__convert_from_py(PyObject * _pymsg, void * _ros_message);
...
bool geographic_msgs__msg__geographic_map__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("geographic_msgs.msg._geographic_map.GeographicMap", full_classname_dest, 49) == 0);
  }
  geographic_msgs__msg__GeographicMap * ros_message = _ros_message;
  {  // header
  ...
  {  // features
    ...
    if (!geographic_msgs__msg__MapFeature__Sequence__init(&(ros_message->features), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create geographic_msgs__msg__MapFeature__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    geographic_msgs__msg__MapFeature * dest = ros_message->features.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!geographic_msgs__msg__map_feature__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
{
  /* NOTE(esteve): Call constructor of GeographicMap */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("geographic_msgs.msg._geographic_map");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GeographicMap");
  ...
  {  // features
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = geographic_msgs__msg__map_feature__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
