...
bool geographic_msgs__msg__geo_pose__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("geographic_msgs.msg._geo_pose.GeoPose", full_classname_dest, 37) == 0);
  }
  geographic_msgs__msg__GeoPose * ros_message = _ros_message;
  {  // position
...
{
  /* NOTE(esteve): Call constructor of GeoPose */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("geographic_msgs.msg._geo_pose");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "GeoPose");
