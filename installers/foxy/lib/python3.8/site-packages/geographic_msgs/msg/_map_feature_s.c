...
bool geographic_msgs__msg__map_feature__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("geographic_msgs.msg._map_feature.MapFeature", full_classname_dest, 43) == 0);
  }
  geographic_msgs__msg__MapFeature * ros_message = _ros_message;
  {  // id
  ...
  {  // components
    ...
    unique_identifier_msgs__msg__UUID * dest = ros_message->components.data;
...
{
  /* NOTE(esteve): Call constructor of MapFeature */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("geographic_msgs.msg._map_feature");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "MapFeature");
