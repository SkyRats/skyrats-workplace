...
namespace geographic_msgs {
    namespace msg {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *WayPoint_TYPENAME = "geographic_msgs::msg::dds_::WayPoint_";

            DDS_TypeCode* WayPoint__get_typecode()
            {
                static RTIBool is_initialized = RTI_FALSE;

                static DDS_TypeCode WayPoint__g_tc_props__sequence = DDS_INITIALIZE_SEQUENCE_TYPECODE(RTI_INT32_MAX,NULL);
                static DDS_TypeCode_Member WayPoint__g_tc_members[3]=
                {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"geographic_msgs::msg::dds_::WayPoint_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                ...
                WayPoint__g_tc_props__sequence._data._typeCode = (RTICdrTypeCode *)geographic_msgs::msg::dds_::KeyValue__get_typecode();

                WayPoint__g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)unique_identifier_msgs::msg::dds_::UUID__get_typecode();

                WayPoint__g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)geographic_msgs::msg::dds_::GeoPoint__get_typecode();

                WayPoint__g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)& WayPoint__g_tc_props__sequence;
            ...
            RTIBool WayPoint__initialize(
                WayPoint_* sample) {
                return geographic_msgs::msg::dds_::WayPoint__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                WayPoint_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return geographic_msgs::msg::dds_::WayPoint__initialize_w_params(
                    sample,&allocParams);
                ...
                WayPoint_* sample)
            {
                ...
                geographic_msgs::msg::dds_::WayPoint__finalize_ex(sample,RTI_TRUE);
            }
                ...
                WayPoint_* sample,RTIBool deletePointers)
            {
                ...
                geographic_msgs::msg::dds_::WayPoint__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params geographic_msgs::msg::dds_::WayPoint__initialize_w_params

            #define T_finalize_w_params   geographic_msgs::msg::dds_::WayPoint__finalize_w_params
            #define T_copy       geographic_msgs::msg::dds_::WayPoint__copy
