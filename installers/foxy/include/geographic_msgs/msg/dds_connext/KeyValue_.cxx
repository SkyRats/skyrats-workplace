...
namespace geographic_msgs {
    namespace msg {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *KeyValue_TYPENAME = "geographic_msgs::msg::dds_::KeyValue_";
            ...
            DDS_TypeCode* KeyValue__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"geographic_msgs::msg::dds_::KeyValue_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool KeyValue__initialize(
                KeyValue_* sample) {
                return geographic_msgs::msg::dds_::KeyValue__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                KeyValue_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return geographic_msgs::msg::dds_::KeyValue__initialize_w_params(
                    sample,&allocParams);
                ...
                KeyValue_* sample)
            {
                ...
                geographic_msgs::msg::dds_::KeyValue__finalize_ex(sample,RTI_TRUE);
            }
                ...
                KeyValue_* sample,RTIBool deletePointers)
            {
                ...
                geographic_msgs::msg::dds_::KeyValue__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params geographic_msgs::msg::dds_::KeyValue__initialize_w_params

            #define T_finalize_w_params   geographic_msgs::msg::dds_::KeyValue__finalize_w_params
            #define T_copy       geographic_msgs::msg::dds_::KeyValue__copy
