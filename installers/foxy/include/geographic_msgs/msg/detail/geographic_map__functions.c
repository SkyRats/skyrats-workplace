...
{
  geographic_msgs__msg__GeographicMap * msg = (geographic_msgs__msg__GeographicMap *)malloc(sizeof(geographic_msgs__msg__GeographicMap));
  if (!msg) {
    return NULL;
  }
...
geographic_msgs__msg__GeographicMap__Sequence__init(geographic_msgs__msg__GeographicMap__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (geographic_msgs__msg__GeographicMap *)calloc(size, sizeof(geographic_msgs__msg__GeographicMap));
    if (!data) {
      return false;
    }
...
{
  geographic_msgs__msg__GeographicMap__Sequence * array = (geographic_msgs__msg__GeographicMap__Sequence *)malloc(sizeof(geographic_msgs__msg__GeographicMap__Sequence));
  if (!array) {
    return NULL;
  }
