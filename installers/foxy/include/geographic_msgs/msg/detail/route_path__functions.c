...
{
  geographic_msgs__msg__RoutePath * msg = (geographic_msgs__msg__RoutePath *)malloc(sizeof(geographic_msgs__msg__RoutePath));
  if (!msg) {
    return NULL;
  }
...
geographic_msgs__msg__RoutePath__Sequence__init(geographic_msgs__msg__RoutePath__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (geographic_msgs__msg__RoutePath *)calloc(size, sizeof(geographic_msgs__msg__RoutePath));
    if (!data) {
      return false;
    }
...
{
  geographic_msgs__msg__RoutePath__Sequence * array = (geographic_msgs__msg__RoutePath__Sequence *)malloc(sizeof(geographic_msgs__msg__RoutePath__Sequence));
  if (!array) {
    return NULL;
  }
