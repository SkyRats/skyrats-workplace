...
#ifndef GEOGRAPHIC_MSGS__MSG__DETAIL__BOUNDING_BOX__FUNCTIONS_H_
#define GEOGRAPHIC_MSGS__MSG__DETAIL__BOUNDING_BOX__FUNCTIONS_H_
 ...
 * calls
 * geographic_msgs__msg__BoundingBox__init().
...
/**
 * It calls
 * geographic_msgs__msg__BoundingBox__fini()
 ...
 * geographic_msgs__msg__BoundingBox__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * geographic_msgs__msg__BoundingBox__Sequence__fini()
 * on the array,
...
#endif  // GEOGRAPHIC_MSGS__MSG__DETAIL__BOUNDING_BOX__FUNCTIONS_H_
