...
{
  geographic_msgs__msg__MapFeature * msg = (geographic_msgs__msg__MapFeature *)malloc(sizeof(geographic_msgs__msg__MapFeature));
  if (!msg) {
    return NULL;
  }
...
geographic_msgs__msg__MapFeature__Sequence__init(geographic_msgs__msg__MapFeature__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (geographic_msgs__msg__MapFeature *)calloc(size, sizeof(geographic_msgs__msg__MapFeature));
    if (!data) {
      return false;
    }
...
{
  geographic_msgs__msg__MapFeature__Sequence * array = (geographic_msgs__msg__MapFeature__Sequence *)malloc(sizeof(geographic_msgs__msg__MapFeature__Sequence));
  if (!array) {
    return NULL;
  }
