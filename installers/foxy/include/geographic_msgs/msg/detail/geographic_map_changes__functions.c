...
{
  geographic_msgs__msg__GeographicMapChanges * msg = (geographic_msgs__msg__GeographicMapChanges *)malloc(sizeof(geographic_msgs__msg__GeographicMapChanges));
  if (!msg) {
    return NULL;
  }
...
geographic_msgs__msg__GeographicMapChanges__Sequence__init(geographic_msgs__msg__GeographicMapChanges__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (geographic_msgs__msg__GeographicMapChanges *)calloc(size, sizeof(geographic_msgs__msg__GeographicMapChanges));
    if (!data) {
      return false;
    }
...
{
  geographic_msgs__msg__GeographicMapChanges__Sequence * array = (geographic_msgs__msg__GeographicMapChanges__Sequence *)malloc(sizeof(geographic_msgs__msg__GeographicMapChanges__Sequence));
  if (!array) {
    return NULL;
  }
