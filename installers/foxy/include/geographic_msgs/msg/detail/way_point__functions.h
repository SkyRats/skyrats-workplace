...
#ifndef GEOGRAPHIC_MSGS__MSG__DETAIL__WAY_POINT__FUNCTIONS_H_
#define GEOGRAPHIC_MSGS__MSG__DETAIL__WAY_POINT__FUNCTIONS_H_
 ...
 * calls
 * geographic_msgs__msg__WayPoint__init().
...
/**
 * It calls
 * geographic_msgs__msg__WayPoint__fini()
 ...
 * geographic_msgs__msg__WayPoint__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * geographic_msgs__msg__WayPoint__Sequence__fini()
 * on the array,
...
#endif  // GEOGRAPHIC_MSGS__MSG__DETAIL__WAY_POINT__FUNCTIONS_H_
