...
{
  geographic_msgs__srv__UpdateGeographicMap_Request * msg = (geographic_msgs__srv__UpdateGeographicMap_Request *)malloc(sizeof(geographic_msgs__srv__UpdateGeographicMap_Request));
  if (!msg) {
    return NULL;
  }
...
geographic_msgs__srv__UpdateGeographicMap_Request__Sequence__init(geographic_msgs__srv__UpdateGeographicMap_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (geographic_msgs__srv__UpdateGeographicMap_Request *)calloc(size, sizeof(geographic_msgs__srv__UpdateGeographicMap_Request));
    if (!data) {
      return false;
    }
...
{
  geographic_msgs__srv__UpdateGeographicMap_Request__Sequence * array = (geographic_msgs__srv__UpdateGeographicMap_Request__Sequence *)malloc(sizeof(geographic_msgs__srv__UpdateGeographicMap_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  geographic_msgs__srv__UpdateGeographicMap_Response * msg = (geographic_msgs__srv__UpdateGeographicMap_Response *)malloc(sizeof(geographic_msgs__srv__UpdateGeographicMap_Response));
  if (!msg) {
    return NULL;
  }
...
geographic_msgs__srv__UpdateGeographicMap_Response__Sequence__init(geographic_msgs__srv__UpdateGeographicMap_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (geographic_msgs__srv__UpdateGeographicMap_Response *)calloc(size, sizeof(geographic_msgs__srv__UpdateGeographicMap_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  geographic_msgs__srv__UpdateGeographicMap_Response__Sequence * array = (geographic_msgs__srv__UpdateGeographicMap_Response__Sequence *)malloc(sizeof(geographic_msgs__srv__UpdateGeographicMap_Response__Sequence));
  if (!array) {
    return NULL;
  }
