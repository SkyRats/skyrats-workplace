...
#ifndef MetricsMessage_Plugin_2136864935_h
#define MetricsMessage_Plugin_2136864935_h
...
#include "statistics_msgs/msg/dds_connext/StatisticDataPoint_Plugin.h"
...
namespace statistics_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define MetricsMessage_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define MetricsMessage_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define MetricsMessage_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define MetricsMessage_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define MetricsMessage_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern MetricsMessage_*
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            MetricsMessage_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                MetricsMessage_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            MetricsMessage_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                MetricsMessage_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            MetricsMessage_Plugin_new(void);

            NDDSUSERDllExport extern void
            MetricsMessage_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* MetricsMessage_Plugin_2136864935_h */
