...
void SwitchController_Request__rosidl_typesupport_introspection_c__SwitchController_Request_init_function(
...
void SwitchController_Request__rosidl_typesupport_introspection_c__SwitchController_Request_fini_function(void * message_memory)
{
  controller_manager_msgs__srv__SwitchController_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SwitchController_Request__rosidl_typesupport_introspection_c__SwitchController_Request_message_member_array[5] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers SwitchController_Request__rosidl_typesupport_introspection_c__SwitchController_Request_message_members = {
  ...
  SwitchController_Request__rosidl_typesupport_introspection_c__SwitchController_Request_message_member_array,  // message members
  SwitchController_Request__rosidl_typesupport_introspection_c__SwitchController_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  SwitchController_Request__rosidl_typesupport_introspection_c__SwitchController_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SwitchController_Request__rosidl_typesupport_introspection_c__SwitchController_Request_message_type_support_handle = {
  0,
  &SwitchController_Request__rosidl_typesupport_introspection_c__SwitchController_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, srv, SwitchController_Request)() {
  SwitchController_Request__rosidl_typesupport_introspection_c__SwitchController_Request_message_member_array[4].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, builtin_interfaces, msg, Duration)();
  if (!SwitchController_Request__rosidl_typesupport_introspection_c__SwitchController_Request_message_type_support_handle.typesupport_identifier) {
    SwitchController_Request__rosidl_typesupport_introspection_c__SwitchController_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SwitchController_Request__rosidl_typesupport_introspection_c__SwitchController_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void SwitchController_Response__rosidl_typesupport_introspection_c__SwitchController_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void SwitchController_Response__rosidl_typesupport_introspection_c__SwitchController_Response_fini_function(void * message_memory)
{
  controller_manager_msgs__srv__SwitchController_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SwitchController_Response__rosidl_typesupport_introspection_c__SwitchController_Response_message_member_array[1] = {
  {
    "ok",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_BOOLEAN,  // type
    0,  // upper bound of string
...
static const rosidl_typesupport_introspection_c__MessageMembers SwitchController_Response__rosidl_typesupport_introspection_c__SwitchController_Response_message_members = {
  "controller_manager_msgs__srv",  // message namespace
  "SwitchController_Response",  // message name
  1,  // number of fields
  sizeof(controller_manager_msgs__srv__SwitchController_Response),
  SwitchController_Response__rosidl_typesupport_introspection_c__SwitchController_Response_message_member_array,  // message members
  SwitchController_Response__rosidl_typesupport_introspection_c__SwitchController_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  SwitchController_Response__rosidl_typesupport_introspection_c__SwitchController_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SwitchController_Response__rosidl_typesupport_introspection_c__SwitchController_Response_message_type_support_handle = {
  0,
  &SwitchController_Response__rosidl_typesupport_introspection_c__SwitchController_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, srv, SwitchController_Response)() {
  if (!SwitchController_Response__rosidl_typesupport_introspection_c__SwitchController_Response_message_type_support_handle.typesupport_identifier) {
    SwitchController_Response__rosidl_typesupport_introspection_c__SwitchController_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SwitchController_Response__rosidl_typesupport_introspection_c__SwitchController_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
