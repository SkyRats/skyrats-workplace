...
struct ListControllers_Response_
{
  ...
  using _controller_type =
    std::vector<controller_manager_msgs::msg::ControllerState_<ContainerAllocator>, typename ContainerAllocator::template rebind<controller_manager_msgs::msg::ControllerState_<ContainerAllocator>>::other>;
  _controller_type controller;

  // setters for named parameter idiom
  Type & set__controller(
    const std::vector<controller_manager_msgs::msg::ControllerState_<ContainerAllocator>, typename ContainerAllocator::template rebind<controller_manager_msgs::msg::ControllerState_<ContainerAllocator>>::other> & _arg)
  {
