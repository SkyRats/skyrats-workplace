...
void LoadController_Request__rosidl_typesupport_introspection_c__LoadController_Request_init_function(
...
void LoadController_Request__rosidl_typesupport_introspection_c__LoadController_Request_fini_function(void * message_memory)
{
  controller_manager_msgs__srv__LoadController_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember LoadController_Request__rosidl_typesupport_introspection_c__LoadController_Request_message_member_array[1] = {
  {
    "name",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers LoadController_Request__rosidl_typesupport_introspection_c__LoadController_Request_message_members = {
  ...
  LoadController_Request__rosidl_typesupport_introspection_c__LoadController_Request_message_member_array,  // message members
  LoadController_Request__rosidl_typesupport_introspection_c__LoadController_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  LoadController_Request__rosidl_typesupport_introspection_c__LoadController_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t LoadController_Request__rosidl_typesupport_introspection_c__LoadController_Request_message_type_support_handle = {
  0,
  &LoadController_Request__rosidl_typesupport_introspection_c__LoadController_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, srv, LoadController_Request)() {
  if (!LoadController_Request__rosidl_typesupport_introspection_c__LoadController_Request_message_type_support_handle.typesupport_identifier) {
    LoadController_Request__rosidl_typesupport_introspection_c__LoadController_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &LoadController_Request__rosidl_typesupport_introspection_c__LoadController_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void LoadController_Response__rosidl_typesupport_introspection_c__LoadController_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void LoadController_Response__rosidl_typesupport_introspection_c__LoadController_Response_fini_function(void * message_memory)
{
  controller_manager_msgs__srv__LoadController_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember LoadController_Response__rosidl_typesupport_introspection_c__LoadController_Response_message_member_array[1] = {
  {
    "ok",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers LoadController_Response__rosidl_typesupport_introspection_c__LoadController_Response_message_members = {
  "controller_manager_msgs__srv",  // message namespace
  "LoadController_Response",  // message name
  1,  // number of fields
  sizeof(controller_manager_msgs__srv__LoadController_Response),
  LoadController_Response__rosidl_typesupport_introspection_c__LoadController_Response_message_member_array,  // message members
  LoadController_Response__rosidl_typesupport_introspection_c__LoadController_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  LoadController_Response__rosidl_typesupport_introspection_c__LoadController_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t LoadController_Response__rosidl_typesupport_introspection_c__LoadController_Response_message_type_support_handle = {
  0,
  &LoadController_Response__rosidl_typesupport_introspection_c__LoadController_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, srv, LoadController_Response)() {
  if (!LoadController_Response__rosidl_typesupport_introspection_c__LoadController_Response_message_type_support_handle.typesupport_identifier) {
    LoadController_Response__rosidl_typesupport_introspection_c__LoadController_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &LoadController_Response__rosidl_typesupport_introspection_c__LoadController_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
