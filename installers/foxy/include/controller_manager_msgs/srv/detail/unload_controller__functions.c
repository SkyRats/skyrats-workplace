...
{
  controller_manager_msgs__srv__UnloadController_Request * msg = (controller_manager_msgs__srv__UnloadController_Request *)malloc(sizeof(controller_manager_msgs__srv__UnloadController_Request));
  if (!msg) {
    return NULL;
  }
...
controller_manager_msgs__srv__UnloadController_Request__Sequence__init(controller_manager_msgs__srv__UnloadController_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (controller_manager_msgs__srv__UnloadController_Request *)calloc(size, sizeof(controller_manager_msgs__srv__UnloadController_Request));
    if (!data) {
      return false;
    }
...
{
  controller_manager_msgs__srv__UnloadController_Request__Sequence * array = (controller_manager_msgs__srv__UnloadController_Request__Sequence *)malloc(sizeof(controller_manager_msgs__srv__UnloadController_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  controller_manager_msgs__srv__UnloadController_Response * msg = (controller_manager_msgs__srv__UnloadController_Response *)malloc(sizeof(controller_manager_msgs__srv__UnloadController_Response));
  if (!msg) {
    return NULL;
  }
...
controller_manager_msgs__srv__UnloadController_Response__Sequence__init(controller_manager_msgs__srv__UnloadController_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (controller_manager_msgs__srv__UnloadController_Response *)calloc(size, sizeof(controller_manager_msgs__srv__UnloadController_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  controller_manager_msgs__srv__UnloadController_Response__Sequence * array = (controller_manager_msgs__srv__UnloadController_Response__Sequence *)malloc(sizeof(controller_manager_msgs__srv__UnloadController_Response__Sequence));
  if (!array) {
    return NULL;
  }
