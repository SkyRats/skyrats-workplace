...
void ListControllerTypes_Request__rosidl_typesupport_introspection_c__ListControllerTypes_Request_init_function(
...
void ListControllerTypes_Request__rosidl_typesupport_introspection_c__ListControllerTypes_Request_fini_function(void * message_memory)
{
  controller_manager_msgs__srv__ListControllerTypes_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ListControllerTypes_Request__rosidl_typesupport_introspection_c__ListControllerTypes_Request_message_member_array[1] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers ListControllerTypes_Request__rosidl_typesupport_introspection_c__ListControllerTypes_Request_message_members = {
  ...
  ListControllerTypes_Request__rosidl_typesupport_introspection_c__ListControllerTypes_Request_message_member_array,  // message members
  ListControllerTypes_Request__rosidl_typesupport_introspection_c__ListControllerTypes_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  ListControllerTypes_Request__rosidl_typesupport_introspection_c__ListControllerTypes_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t ListControllerTypes_Request__rosidl_typesupport_introspection_c__ListControllerTypes_Request_message_type_support_handle = {
  0,
  &ListControllerTypes_Request__rosidl_typesupport_introspection_c__ListControllerTypes_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, srv, ListControllerTypes_Request)() {
  if (!ListControllerTypes_Request__rosidl_typesupport_introspection_c__ListControllerTypes_Request_message_type_support_handle.typesupport_identifier) {
    ListControllerTypes_Request__rosidl_typesupport_introspection_c__ListControllerTypes_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &ListControllerTypes_Request__rosidl_typesupport_introspection_c__ListControllerTypes_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void ListControllerTypes_Response__rosidl_typesupport_introspection_c__ListControllerTypes_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void ListControllerTypes_Response__rosidl_typesupport_introspection_c__ListControllerTypes_Response_fini_function(void * message_memory)
{
  controller_manager_msgs__srv__ListControllerTypes_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ListControllerTypes_Response__rosidl_typesupport_introspection_c__ListControllerTypes_Response_message_member_array[2] = {
  {
    "types",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers ListControllerTypes_Response__rosidl_typesupport_introspection_c__ListControllerTypes_Response_message_members = {
  "controller_manager_msgs__srv",  // message namespace
  "ListControllerTypes_Response",  // message name
  2,  // number of fields
  sizeof(controller_manager_msgs__srv__ListControllerTypes_Response),
  ListControllerTypes_Response__rosidl_typesupport_introspection_c__ListControllerTypes_Response_message_member_array,  // message members
  ListControllerTypes_Response__rosidl_typesupport_introspection_c__ListControllerTypes_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  ListControllerTypes_Response__rosidl_typesupport_introspection_c__ListControllerTypes_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t ListControllerTypes_Response__rosidl_typesupport_introspection_c__ListControllerTypes_Response_message_type_support_handle = {
  0,
  &ListControllerTypes_Response__rosidl_typesupport_introspection_c__ListControllerTypes_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, controller_manager_msgs, srv, ListControllerTypes_Response)() {
  if (!ListControllerTypes_Response__rosidl_typesupport_introspection_c__ListControllerTypes_Response_message_type_support_handle.typesupport_identifier) {
    ListControllerTypes_Response__rosidl_typesupport_introspection_c__ListControllerTypes_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &ListControllerTypes_Response__rosidl_typesupport_introspection_c__ListControllerTypes_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
