...
public:
  ...
  : msg_(msg)
  {}
  Init_SwitchController_Request_timeout start_asap(::controller_manager_msgs::srv::SwitchController_Request::_start_asap_type arg)
  {
...
{
public:
  Init_SwitchController_Request_start_controllers()
...
{
  return controller_manager_msgs::srv::builder::Init_SwitchController_Request_start_controllers();
}
