...
#ifndef ListControllers_Plugin_91617079_h
#define ListControllers_Plugin_91617079_h
...
namespace controller_manager_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define ListControllers_Request_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define ListControllers_Request_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define ListControllers_Request_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define ListControllers_Request_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define ListControllers_Request_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern ListControllers_Request_*
            ...
            ListControllers_Request_PluginSupport_copy_data(
                ListControllers_Request_ *out,
                const ListControllers_Request_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            ListControllers_Request_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            ListControllers_Request_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                ListControllers_Request_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            ListControllers_Request_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ListControllers_Request_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            ListControllers_Request_Plugin_new(void);

            NDDSUSERDllExport extern void
            ListControllers_Request_Plugin_delete(struct PRESTypePlugin *);
...
namespace controller_manager_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define ListControllers_Response_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define ListControllers_Response_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define ListControllers_Response_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define ListControllers_Response_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define ListControllers_Response_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern ListControllers_Response_*
            ...
            ListControllers_Response_PluginSupport_copy_data(
                ListControllers_Response_ *out,
                const ListControllers_Response_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            ListControllers_Response_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            ListControllers_Response_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                ListControllers_Response_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            ListControllers_Response_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ListControllers_Response_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            ListControllers_Response_Plugin_new(void);

            NDDSUSERDllExport extern void
            ListControllers_Response_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* ListControllers_Plugin_91617079_h */
