...
#ifndef ListControllerTypes_Plugin_843727314_h
#define ListControllerTypes_Plugin_843727314_h
...
namespace controller_manager_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define ListControllerTypes_Request_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define ListControllerTypes_Request_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define ListControllerTypes_Request_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define ListControllerTypes_Request_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define ListControllerTypes_Request_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern ListControllerTypes_Request_*
            ...
            ListControllerTypes_Request_PluginSupport_copy_data(
                ListControllerTypes_Request_ *out,
                const ListControllerTypes_Request_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            ListControllerTypes_Request_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            ListControllerTypes_Request_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                ListControllerTypes_Request_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            ListControllerTypes_Request_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ListControllerTypes_Request_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            ListControllerTypes_Request_Plugin_new(void);

            NDDSUSERDllExport extern void
            ListControllerTypes_Request_Plugin_delete(struct PRESTypePlugin *);
...
namespace controller_manager_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define ListControllerTypes_Response_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define ListControllerTypes_Response_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define ListControllerTypes_Response_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define ListControllerTypes_Response_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define ListControllerTypes_Response_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern ListControllerTypes_Response_*
            ...
            ListControllerTypes_Response_PluginSupport_copy_data(
                ListControllerTypes_Response_ *out,
                const ListControllerTypes_Response_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            ListControllerTypes_Response_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            ListControllerTypes_Response_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                ListControllerTypes_Response_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            ListControllerTypes_Response_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ListControllerTypes_Response_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            ListControllerTypes_Response_Plugin_new(void);

            NDDSUSERDllExport extern void
            ListControllerTypes_Response_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* ListControllerTypes_Plugin_843727314_h */
