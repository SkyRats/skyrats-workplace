...
namespace gazebo_msgs {
    namespace srv {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *SetEntityState_Request_TYPENAME = "gazebo_msgs::srv::dds_::SetEntityState_Request_";
            ...
            DDS_TypeCode* SetEntityState_Request__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"gazebo_msgs::srv::dds_::SetEntityState_Request_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                ...
                SetEntityState_Request__g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)gazebo_msgs::msg::dds_::EntityState__get_typecode();
            ...
            RTIBool SetEntityState_Request__initialize(
                ...
                return gazebo_msgs::srv::dds_::SetEntityState_Request__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                SetEntityState_Request_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return gazebo_msgs::srv::dds_::SetEntityState_Request__initialize_w_params(
                    sample,&allocParams);
                ...
                SetEntityState_Request_* sample)
            {
                ...
                gazebo_msgs::srv::dds_::SetEntityState_Request__finalize_ex(sample,RTI_TRUE);
            }
                ...
                SetEntityState_Request_* sample,RTIBool deletePointers)
            {
                ...
                gazebo_msgs::srv::dds_::SetEntityState_Request__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params gazebo_msgs::srv::dds_::SetEntityState_Request__initialize_w_params

            #define T_finalize_w_params   gazebo_msgs::srv::dds_::SetEntityState_Request__finalize_w_params
            #define T_copy       gazebo_msgs::srv::dds_::SetEntityState_Request__copy
...
namespace gazebo_msgs {
    namespace srv {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *SetEntityState_Response_TYPENAME = "gazebo_msgs::srv::dds_::SetEntityState_Response_";
            ...
            DDS_TypeCode* SetEntityState_Response__get_typecode()
            {
                ...
                {{
                        ...
                        DDS_BOOLEAN_FALSE, /* Ignored */
                        -1, /*Ignored*/
                        (char *)"gazebo_msgs::srv::dds_::SetEntityState_Response_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool SetEntityState_Response__initialize(
                ...
                return gazebo_msgs::srv::dds_::SetEntityState_Response__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                SetEntityState_Response_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return gazebo_msgs::srv::dds_::SetEntityState_Response__initialize_w_params(
                    sample,&allocParams);
                ...
                SetEntityState_Response_* sample)
            {
                ...
                gazebo_msgs::srv::dds_::SetEntityState_Response__finalize_ex(sample,RTI_TRUE);
            }
                ...
                SetEntityState_Response_* sample,RTIBool deletePointers)
            {
                ...
                gazebo_msgs::srv::dds_::SetEntityState_Response__finalize_w_params(
                    sample,&deallocParams);
            }
            ...
            */
            ...
            #define T_initialize_w_params gazebo_msgs::srv::dds_::SetEntityState_Response__initialize_w_params

            #define T_finalize_w_params   gazebo_msgs::srv::dds_::SetEntityState_Response__finalize_w_params
            #define T_copy       gazebo_msgs::srv::dds_::SetEntityState_Response__copy
