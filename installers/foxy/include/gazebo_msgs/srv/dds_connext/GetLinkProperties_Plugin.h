...
#ifndef GetLinkProperties_Plugin_1202869380_h
#define GetLinkProperties_Plugin_1202869380_h
...
namespace gazebo_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define GetLinkProperties_Request_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define GetLinkProperties_Request_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define GetLinkProperties_Request_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define GetLinkProperties_Request_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define GetLinkProperties_Request_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern GetLinkProperties_Request_*
            ...
            GetLinkProperties_Request_PluginSupport_copy_data(
                GetLinkProperties_Request_ *out,
                const GetLinkProperties_Request_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            GetLinkProperties_Request_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            GetLinkProperties_Request_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                GetLinkProperties_Request_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            GetLinkProperties_Request_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                GetLinkProperties_Request_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            GetLinkProperties_Request_Plugin_new(void);

            NDDSUSERDllExport extern void
            GetLinkProperties_Request_Plugin_delete(struct PRESTypePlugin *);
...
namespace gazebo_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define GetLinkProperties_Response_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define GetLinkProperties_Response_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define GetLinkProperties_Response_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define GetLinkProperties_Response_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define GetLinkProperties_Response_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern GetLinkProperties_Response_*
            ...
            GetLinkProperties_Response_PluginSupport_copy_data(
                GetLinkProperties_Response_ *out,
                const GetLinkProperties_Response_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            GetLinkProperties_Response_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            GetLinkProperties_Response_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                GetLinkProperties_Response_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            GetLinkProperties_Response_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                GetLinkProperties_Response_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            GetLinkProperties_Response_Plugin_new(void);

            NDDSUSERDllExport extern void
            GetLinkProperties_Response_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* GetLinkProperties_Plugin_1202869380_h */
