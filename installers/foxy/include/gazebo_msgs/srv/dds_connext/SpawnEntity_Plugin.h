...
#ifndef SpawnEntity_Plugin_465644298_h
#define SpawnEntity_Plugin_465644298_h
...
namespace gazebo_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define SpawnEntity_Request_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define SpawnEntity_Request_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define SpawnEntity_Request_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define SpawnEntity_Request_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define SpawnEntity_Request_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern SpawnEntity_Request_*
            ...
            SpawnEntity_Request_PluginSupport_copy_data(
                SpawnEntity_Request_ *out,
                const SpawnEntity_Request_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            SpawnEntity_Request_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            SpawnEntity_Request_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                SpawnEntity_Request_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            SpawnEntity_Request_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                SpawnEntity_Request_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            SpawnEntity_Request_Plugin_new(void);

            NDDSUSERDllExport extern void
            SpawnEntity_Request_Plugin_delete(struct PRESTypePlugin *);
...
namespace gazebo_msgs {
    namespace srv {
        namespace dds_ {
            ...
            #define SpawnEntity_Response_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define SpawnEntity_Response_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define SpawnEntity_Response_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define SpawnEntity_Response_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define SpawnEntity_Response_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern SpawnEntity_Response_*
            ...
            SpawnEntity_Response_PluginSupport_copy_data(
                SpawnEntity_Response_ *out,
                const SpawnEntity_Response_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            SpawnEntity_Response_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            SpawnEntity_Response_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                SpawnEntity_Response_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            SpawnEntity_Response_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                SpawnEntity_Response_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            SpawnEntity_Response_Plugin_new(void);

            NDDSUSERDllExport extern void
            SpawnEntity_Response_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* SpawnEntity_Plugin_465644298_h */
