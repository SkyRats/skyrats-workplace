...
namespace gazebo_msgs {
    namespace srv {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *SpawnEntity_Request_TYPENAME = "gazebo_msgs::srv::dds_::SpawnEntity_Request_";

            DDS_TypeCode* SpawnEntity_Request__get_typecode()
            {
                static RTIBool is_initialized = RTI_FALSE;

                static DDS_TypeCode SpawnEntity_Request__g_tc_name__string = DDS_INITIALIZE_STRING_TYPECODE(RTI_INT32_MAX);
                ...
                static DDS_TypeCode SpawnEntity_Request__g_tc_reference_frame__string = DDS_INITIALIZE_STRING_TYPECODE(RTI_INT32_MAX);
                static DDS_TypeCode_Member SpawnEntity_Request__g_tc_members[5]=
                {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"gazebo_msgs::srv::dds_::SpawnEntity_Request_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                ...
                SpawnEntity_Request__g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)&SpawnEntity_Request__g_tc_name__string;

                SpawnEntity_Request__g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)&SpawnEntity_Request__g_tc_xml__string;

                SpawnEntity_Request__g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&SpawnEntity_Request__g_tc_robot_namespace__string;

                SpawnEntity_Request__g_tc_members[3]._representation._typeCode = (RTICdrTypeCode *)geometry_msgs::msg::dds_::Pose__get_typecode();

                SpawnEntity_Request__g_tc_members[4]._representation._typeCode = (RTICdrTypeCode *)&SpawnEntity_Request__g_tc_reference_frame__string;
            ...
            RTIBool SpawnEntity_Request__initialize(
                ...
                return gazebo_msgs::srv::dds_::SpawnEntity_Request__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                SpawnEntity_Request_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return gazebo_msgs::srv::dds_::SpawnEntity_Request__initialize_w_params(
                    sample,&allocParams);
                ...
                SpawnEntity_Request_* sample)
            {
                ...
                gazebo_msgs::srv::dds_::SpawnEntity_Request__finalize_ex(sample,RTI_TRUE);
            }
                ...
                SpawnEntity_Request_* sample,RTIBool deletePointers)
            {
                ...
                gazebo_msgs::srv::dds_::SpawnEntity_Request__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params gazebo_msgs::srv::dds_::SpawnEntity_Request__initialize_w_params

            #define T_finalize_w_params   gazebo_msgs::srv::dds_::SpawnEntity_Request__finalize_w_params
            #define T_copy       gazebo_msgs::srv::dds_::SpawnEntity_Request__copy
...
namespace gazebo_msgs {
    namespace srv {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *SpawnEntity_Response_TYPENAME = "gazebo_msgs::srv::dds_::SpawnEntity_Response_";
            ...
            DDS_TypeCode* SpawnEntity_Response__get_typecode()
            {
                ...
                {{
                        ...
                        DDS_BOOLEAN_FALSE, /* Ignored */
                        -1, /*Ignored*/
                        (char *)"gazebo_msgs::srv::dds_::SpawnEntity_Response_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool SpawnEntity_Response__initialize(
                ...
                return gazebo_msgs::srv::dds_::SpawnEntity_Response__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                SpawnEntity_Response_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return gazebo_msgs::srv::dds_::SpawnEntity_Response__initialize_w_params(
                    sample,&allocParams);
                ...
                SpawnEntity_Response_* sample)
            {
                ...
                gazebo_msgs::srv::dds_::SpawnEntity_Response__finalize_ex(sample,RTI_TRUE);
            }
                ...
                SpawnEntity_Response_* sample,RTIBool deletePointers)
            {
                ...
                gazebo_msgs::srv::dds_::SpawnEntity_Response__finalize_w_params(
                    sample,&deallocParams);
            }
            ...
            */
            ...
            #define T_initialize_w_params gazebo_msgs::srv::dds_::SpawnEntity_Response__initialize_w_params

            #define T_finalize_w_params   gazebo_msgs::srv::dds_::SpawnEntity_Response__finalize_w_params
            #define T_copy       gazebo_msgs::srv::dds_::SpawnEntity_Response__copy
