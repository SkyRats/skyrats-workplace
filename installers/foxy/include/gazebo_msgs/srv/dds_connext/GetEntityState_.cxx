...
namespace gazebo_msgs {
    namespace srv {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *GetEntityState_Request_TYPENAME = "gazebo_msgs::srv::dds_::GetEntityState_Request_";
            ...
            DDS_TypeCode* GetEntityState_Request__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"gazebo_msgs::srv::dds_::GetEntityState_Request_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool GetEntityState_Request__initialize(
                ...
                return gazebo_msgs::srv::dds_::GetEntityState_Request__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                GetEntityState_Request_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return gazebo_msgs::srv::dds_::GetEntityState_Request__initialize_w_params(
                    sample,&allocParams);
                ...
                GetEntityState_Request_* sample)
            {
                ...
                gazebo_msgs::srv::dds_::GetEntityState_Request__finalize_ex(sample,RTI_TRUE);
            }
                ...
                GetEntityState_Request_* sample,RTIBool deletePointers)
            {
                ...
                gazebo_msgs::srv::dds_::GetEntityState_Request__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params gazebo_msgs::srv::dds_::GetEntityState_Request__initialize_w_params

            #define T_finalize_w_params   gazebo_msgs::srv::dds_::GetEntityState_Request__finalize_w_params
            #define T_copy       gazebo_msgs::srv::dds_::GetEntityState_Request__copy
...
namespace gazebo_msgs {
    namespace srv {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *GetEntityState_Response_TYPENAME = "gazebo_msgs::srv::dds_::GetEntityState_Response_";

            DDS_TypeCode* GetEntityState_Response__get_typecode()
            {
                static RTIBool is_initialized = RTI_FALSE;

                static DDS_TypeCode_Member GetEntityState_Response__g_tc_members[3]=
                {
                ...
                {{
                        ...
                        DDS_BOOLEAN_FALSE, /* Ignored */
                        -1, /*Ignored*/
                        (char *)"gazebo_msgs::srv::dds_::GetEntityState_Response_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                ...
                GetEntityState_Response__g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)std_msgs::msg::dds_::Header__get_typecode();

                GetEntityState_Response__g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)gazebo_msgs::msg::dds_::EntityState__get_typecode();

                GetEntityState_Response__g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)&DDS_g_tc_boolean;
            ...
            RTIBool GetEntityState_Response__initialize(
                ...
                return gazebo_msgs::srv::dds_::GetEntityState_Response__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                GetEntityState_Response_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return gazebo_msgs::srv::dds_::GetEntityState_Response__initialize_w_params(
                    sample,&allocParams);
                ...
                GetEntityState_Response_* sample, const struct DDS_TypeAllocationParams_t * allocParams)
            {
                ...
                if (!gazebo_msgs::msg::dds_::EntityState__initialize_w_params(&sample->state_,
                allocParams)) {
                    return RTI_FALSE;
                }
                ...
                GetEntityState_Response_* sample)
            {
                ...
                gazebo_msgs::srv::dds_::GetEntityState_Response__finalize_ex(sample,RTI_TRUE);
            }
                ...
                GetEntityState_Response_* sample,RTIBool deletePointers)
            {
                ...
                gazebo_msgs::srv::dds_::GetEntityState_Response__finalize_w_params(
                    sample,&deallocParams);
            }
                ...
                GetEntityState_Response_* sample,const struct DDS_TypeDeallocationParams_t * deallocParams)
            {
                ...
                gazebo_msgs::msg::dds_::EntityState__finalize_w_params(&sample->state_,deallocParams);
                ...
                GetEntityState_Response_* sample, RTIBool deletePointers)
            {
                ...
                gazebo_msgs::msg::dds_::EntityState__finalize_optional_members(&sample->state_, deallocParams->delete_pointers);
            }
                ...
                const GetEntityState_Response_* src)
            {
                try {
                    ...
                    if (!gazebo_msgs::msg::dds_::EntityState__copy(
                        &dst->state_,(const gazebo_msgs::msg::dds_::EntityState_*)&src->state_)) {
                        return RTI_FALSE;
                    } 
            ...
            */
            ...
            #define T_initialize_w_params gazebo_msgs::srv::dds_::GetEntityState_Response__initialize_w_params

            #define T_finalize_w_params   gazebo_msgs::srv::dds_::GetEntityState_Response__finalize_w_params
            #define T_copy       gazebo_msgs::srv::dds_::GetEntityState_Response__copy
