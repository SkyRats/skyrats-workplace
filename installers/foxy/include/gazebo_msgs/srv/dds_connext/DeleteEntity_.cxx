...
namespace gazebo_msgs {
    namespace srv {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *DeleteEntity_Request_TYPENAME = "gazebo_msgs::srv::dds_::DeleteEntity_Request_";
            ...
            DDS_TypeCode* DeleteEntity_Request__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"gazebo_msgs::srv::dds_::DeleteEntity_Request_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool DeleteEntity_Request__initialize(
                ...
                return gazebo_msgs::srv::dds_::DeleteEntity_Request__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                DeleteEntity_Request_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return gazebo_msgs::srv::dds_::DeleteEntity_Request__initialize_w_params(
                    sample,&allocParams);
                ...
                DeleteEntity_Request_* sample)
            {
                ...
                gazebo_msgs::srv::dds_::DeleteEntity_Request__finalize_ex(sample,RTI_TRUE);
            }
                ...
                DeleteEntity_Request_* sample,RTIBool deletePointers)
            {
                ...
                gazebo_msgs::srv::dds_::DeleteEntity_Request__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params gazebo_msgs::srv::dds_::DeleteEntity_Request__initialize_w_params

            #define T_finalize_w_params   gazebo_msgs::srv::dds_::DeleteEntity_Request__finalize_w_params
            #define T_copy       gazebo_msgs::srv::dds_::DeleteEntity_Request__copy
...
namespace gazebo_msgs {
    namespace srv {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *DeleteEntity_Response_TYPENAME = "gazebo_msgs::srv::dds_::DeleteEntity_Response_";
            ...
            DDS_TypeCode* DeleteEntity_Response__get_typecode()
            {
                ...
                {{
                        ...
                        DDS_BOOLEAN_FALSE, /* Ignored */
                        -1, /*Ignored*/
                        (char *)"gazebo_msgs::srv::dds_::DeleteEntity_Response_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool DeleteEntity_Response__initialize(
                ...
                return gazebo_msgs::srv::dds_::DeleteEntity_Response__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                DeleteEntity_Response_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return gazebo_msgs::srv::dds_::DeleteEntity_Response__initialize_w_params(
                    sample,&allocParams);
                ...
                DeleteEntity_Response_* sample)
            {
                ...
                gazebo_msgs::srv::dds_::DeleteEntity_Response__finalize_ex(sample,RTI_TRUE);
            }
                ...
                DeleteEntity_Response_* sample,RTIBool deletePointers)
            {
                ...
                gazebo_msgs::srv::dds_::DeleteEntity_Response__finalize_w_params(
                    sample,&deallocParams);
            }
            ...
            */
            ...
            #define T_initialize_w_params gazebo_msgs::srv::dds_::DeleteEntity_Response__initialize_w_params

            #define T_finalize_w_params   gazebo_msgs::srv::dds_::DeleteEntity_Response__finalize_w_params
            #define T_copy       gazebo_msgs::srv::dds_::DeleteEntity_Response__copy
