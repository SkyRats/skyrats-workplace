    ...
    namespace msg {
        namespace dds_ {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                ModelStates_ *sample = NULL;

                sample = new (std::nothrow) ModelStates_ ;
                if (sample == NULL) {
                    return NULL;
                }

                if (!gazebo_msgs::msg::dds_::ModelStates__initialize_w_params(sample,alloc_params)) {
                    delete  sample;
                    sample=NULL;
                }
                return sample; 
            ...
            ModelStates_PluginSupport_create_data_ex(RTIBool allocate_pointers) 
            {
                ...
                if (!gazebo_msgs::msg::dds_::ModelStates__initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                    delete  sample;
                    sample=NULL;
                }
            ...
            {
                return gazebo_msgs::msg::dds_::ModelStates_PluginSupport_create_data_ex(RTI_TRUE);
            }
            ...
            ModelStates_PluginSupport_destroy_data_w_params(
                ...
                gazebo_msgs::msg::dds_::ModelStates__finalize_w_params(sample,dealloc_params);
            ...
            ModelStates_PluginSupport_destroy_data_ex(
                ...
                gazebo_msgs::msg::dds_::ModelStates__finalize_ex(sample,deallocate_pointers);
            ...
            ModelStates_PluginSupport_destroy_data(
                ...
                gazebo_msgs::msg::dds_::ModelStates_PluginSupport_destroy_data_ex(sample,RTI_TRUE);
            ...
            {
                return gazebo_msgs::msg::dds_::ModelStates__copy(dst,(const ModelStates_*) src);
            }
            ...
            * ---------------------------------------------------------------------------- */
                ...
                void *containerPluginContext)
            {
                ...
                epd = PRESTypePluginDefaultEndpointData_new(
                    ...
                    gazebo_msgs::msg::dds_::ModelStates_PluginSupport_create_data,
                    (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
                    gazebo_msgs::msg::dds_::ModelStates_PluginSupport_destroy_data,
                    NULL , NULL );
                ...
                if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                    serializedSampleMaxSize = gazebo_msgs::msg::dds_::ModelStates_Plugin_get_serialized_sample_max_size(
                    ...
                    if (PRESTypePluginDefaultEndpointData_createWriterPool(
                        ...
                        gazebo_msgs::msg::dds_::ModelStates_Plugin_get_serialized_sample_max_size, epd,
                        (PRESTypePluginGetSerializedSampleSizeFunction)
                        gazebo_msgs::msg::dds_::ModelStates_Plugin_get_serialized_sample_size,
                        epd) == RTI_FALSE) {
                ...
                void *handle)
            {
                ...
                ModelStates__finalize_optional_members(sample, RTI_TRUE);
                ...
                const ModelStates_ *src)
            {
                ...
                return gazebo_msgs::msg::dds_::ModelStates_PluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                try {
                    ...
                    if(deserialize_sample) {
                        ...
                        gazebo_msgs::msg::dds_::ModelStates__initialize_ex(sample, RTI_FALSE, RTI_FALSE);
                ...
                const ModelStates_ *sample)
            {
                ...
                result = gazebo_msgs::msg::dds_::ModelStates_Plugin_serialize(
                ...
                unsigned int length)
            {
                ...
                ModelStates__finalize_optional_members(sample, RTI_TRUE);
                return ModelStates_Plugin_deserialize_sample( 
                    NULL, sample,
                ...
                const struct DDS_PrintFormatProperty *property)
            {
                ...
                if (!ModelStates_Plugin_serialize_to_cdr_buffer(
                    NULL, 
                    &length, 
                    sample)) {
                ...
                void *endpoint_plugin_qos)
            {
                ...
                RTIBool result;
                const char *METHOD_NAME = "ModelStates_Plugin_deserialize";
                if (drop_sample) {} /* To avoid warnings */

                stream->_xTypesState.unassignable = RTI_FALSE;
                result= gazebo_msgs::msg::dds_::ModelStates_Plugin_deserialize_sample( 
            ...
            RTIBool ModelStates_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream,   
                ...
                unsigned int current_alignment)
            {
                ...
                size = ModelStates_Plugin_get_serialized_sample_max_size_ex(
            ...
            * -------------------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if(serialize_key) {
                    ...
                    if (!gazebo_msgs::msg::dds_::ModelStates_Plugin_serialize(
                        endpoint_data,
                        sample,
                        stream,
                        RTI_FALSE, encapsulation_id,
            ...
            RTIBool ModelStates_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                ModelStates_ *sample, 
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
                ...
                void *endpoint_plugin_qos)
            {
                try {
                    ...
                    if (deserialize_key) {
                        ...
                        if (!gazebo_msgs::msg::dds_::ModelStates_Plugin_deserialize_sample(
            ...
            RTIBool ModelStates_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ModelStates_ **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if (drop_sample) {} /* To avoid warnings */
                stream->_xTypesState.unassignable = RTI_FALSE;
                result= gazebo_msgs::msg::dds_::ModelStates_Plugin_deserialize_key_sample(
                ...
                unsigned int current_alignment)
            {
                ...
                current_alignment += gazebo_msgs::msg::dds_::ModelStates_Plugin_get_serialized_sample_max_size_ex(
                ...
                unsigned int current_alignment)
            {
                ...
                size = ModelStates_Plugin_get_serialized_key_max_size_ex(
                    endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
            ...
            * ------------------------------------------------------------------------ */
            struct PRESTypePlugin *ModelStates_Plugin_new(void) 
            { 
                ...
                gazebo_msgs::msg::dds_::ModelStates_Plugin_on_participant_attached;
                plugin->onParticipantDetached =
                (PRESTypePluginOnParticipantDetachedCallback)
                gazebo_msgs::msg::dds_::ModelStates_Plugin_on_participant_detached;
                plugin->onEndpointAttached =
                (PRESTypePluginOnEndpointAttachedCallback)
                gazebo_msgs::msg::dds_::ModelStates_Plugin_on_endpoint_attached;
                plugin->onEndpointDetached =
                (PRESTypePluginOnEndpointDetachedCallback)
                gazebo_msgs::msg::dds_::ModelStates_Plugin_on_endpoint_detached;

                plugin->copySampleFnc =
                (PRESTypePluginCopySampleFunction)
                gazebo_msgs::msg::dds_::ModelStates_Plugin_copy_sample;
                plugin->createSampleFnc =
                (PRESTypePluginCreateSampleFunction)
                ModelStates_Plugin_create_sample;
                plugin->destroySampleFnc =
                (PRESTypePluginDestroySampleFunction)
                ModelStates_Plugin_destroy_sample;
                plugin->finalizeOptionalMembersFnc =
                (PRESTypePluginFinalizeOptionalMembersFunction)
                ModelStates__finalize_optional_members;

                plugin->serializeFnc =
                (PRESTypePluginSerializeFunction)
                gazebo_msgs::msg::dds_::ModelStates_Plugin_serialize;
                plugin->deserializeFnc =
                (PRESTypePluginDeserializeFunction)
                gazebo_msgs::msg::dds_::ModelStates_Plugin_deserialize;
                plugin->getSerializedSampleMaxSizeFnc =
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                gazebo_msgs::msg::dds_::ModelStates_Plugin_get_serialized_sample_max_size;
                plugin->getSerializedSampleMinSizeFnc =
                (PRESTypePluginGetSerializedSampleMinSizeFunction)
                gazebo_msgs::msg::dds_::ModelStates_Plugin_get_serialized_sample_min_size;

                plugin->getSampleFnc =
                (PRESTypePluginGetSampleFunction)
                ModelStates_Plugin_get_sample;
                ...
                gazebo_msgs::msg::dds_::ModelStates_Plugin_get_key_kind;
                ...
                */
                ...
                plugin->typeCode =  (struct RTICdrTypeCode *)gazebo_msgs::msg::dds_::ModelStates__get_typecode();
                ...
                ModelStates_Plugin_get_buffer;
                plugin->returnBuffer = 
                (PRESTypePluginReturnBufferFunction)
                ModelStates_Plugin_return_buffer;
                plugin->getSerializedSampleSizeFnc =
                (PRESTypePluginGetSerializedSampleSizeFunction)
                gazebo_msgs::msg::dds_::ModelStates_Plugin_get_serialized_sample_size;

                plugin->endpointTypeName = ModelStates_TYPENAME;

                return plugin;
            }

            void
            ModelStates_Plugin_delete(struct PRESTypePlugin *plugin)
            {
