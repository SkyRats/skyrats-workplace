...
#ifndef ODEJointProperties_Plugin_305118620_h
#define ODEJointProperties_Plugin_305118620_h
...
namespace gazebo_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define ODEJointProperties_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define ODEJointProperties_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define ODEJointProperties_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define ODEJointProperties_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define ODEJointProperties_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern ODEJointProperties_*
            ...
            ODEJointProperties_PluginSupport_copy_data(
                ODEJointProperties_ *out,
                const ODEJointProperties_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            ODEJointProperties_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            ODEJointProperties_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                ODEJointProperties_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            ODEJointProperties_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ODEJointProperties_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            ODEJointProperties_Plugin_new(void);

            NDDSUSERDllExport extern void
            ODEJointProperties_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* ODEJointProperties_Plugin_305118620_h */
