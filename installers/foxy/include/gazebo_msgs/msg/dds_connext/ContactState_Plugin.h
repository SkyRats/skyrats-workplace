...
#ifndef ContactState_Plugin_429277784_h
#define ContactState_Plugin_429277784_h
...
namespace gazebo_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define ContactState_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define ContactState_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define ContactState_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define ContactState_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define ContactState_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern ContactState_*
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            ContactState_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                ContactState_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            ContactState_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ContactState_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            ContactState_Plugin_new(void);

            NDDSUSERDllExport extern void
            ContactState_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* ContactState_Plugin_429277784_h */
