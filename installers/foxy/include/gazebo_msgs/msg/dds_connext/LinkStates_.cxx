...
namespace gazebo_msgs {
    namespace msg {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *LinkStates_TYPENAME = "gazebo_msgs::msg::dds_::LinkStates_";

            DDS_TypeCode* LinkStates__get_typecode()
            {
                static RTIBool is_initialized = RTI_FALSE;

                static DDS_TypeCode LinkStates__g_tc_name__string = DDS_INITIALIZE_STRING_TYPECODE(RTI_INT32_MAX);
                static DDS_TypeCode LinkStates__g_tc_name__sequence = DDS_INITIALIZE_SEQUENCE_TYPECODE(RTI_INT32_MAX,NULL);
                static DDS_TypeCode LinkStates__g_tc_pose__sequence = DDS_INITIALIZE_SEQUENCE_TYPECODE(RTI_INT32_MAX,NULL);
                static DDS_TypeCode LinkStates__g_tc_twist__sequence = DDS_INITIALIZE_SEQUENCE_TYPECODE(RTI_INT32_MAX,NULL);
                static DDS_TypeCode_Member LinkStates__g_tc_members[3]=
                {
                ...
                static DDS_TypeCode LinkStates__g_tc =
                {{
                        DDS_TK_STRUCT,/* Kind */
                        DDS_BOOLEAN_FALSE, /* Ignored */
                        -1, /*Ignored*/
                        (char *)"gazebo_msgs::msg::dds_::LinkStates_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
                        3, /* Number of members */
                        LinkStates__g_tc_members, /* Members */
                        DDS_VM_NONE  /* Ignored */         
                    }}; /* Type code for LinkStates_*/

                if (is_initialized) {
                    return &LinkStates__g_tc;
                }

                LinkStates__g_tc_name__sequence._data._typeCode = (RTICdrTypeCode *)&LinkStates__g_tc_name__string;

                LinkStates__g_tc_pose__sequence._data._typeCode = (RTICdrTypeCode *)geometry_msgs::msg::dds_::Pose__get_typecode();

                LinkStates__g_tc_twist__sequence._data._typeCode = (RTICdrTypeCode *)geometry_msgs::msg::dds_::Twist__get_typecode();

                LinkStates__g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)& LinkStates__g_tc_name__sequence;
                LinkStates__g_tc_members[1]._representation._typeCode = (RTICdrTypeCode *)& LinkStates__g_tc_pose__sequence;
                LinkStates__g_tc_members[2]._representation._typeCode = (RTICdrTypeCode *)& LinkStates__g_tc_twist__sequence;
            ...
            RTIBool LinkStates__initialize(
                LinkStates_* sample) {
                return gazebo_msgs::msg::dds_::LinkStates__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }

            RTIBool LinkStates__initialize_ex(
                LinkStates_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return gazebo_msgs::msg::dds_::LinkStates__initialize_w_params(
                    sample,&allocParams);

            }

            RTIBool LinkStates__initialize_w_params(
                LinkStates_* sample, const struct DDS_TypeAllocationParams_t * allocParams)
            {
                ...
                LinkStates_* sample)
            {
                ...
                gazebo_msgs::msg::dds_::LinkStates__finalize_ex(sample,RTI_TRUE);
            }

            void LinkStates__finalize_ex(
                LinkStates_* sample,RTIBool deletePointers)
            {
                ...
                gazebo_msgs::msg::dds_::LinkStates__finalize_w_params(
                    sample,&deallocParams);
            }

            void LinkStates__finalize_w_params(
                LinkStates_* sample,const struct DDS_TypeDeallocationParams_t * deallocParams)
            {
            ...
            * Defines:  TSeq, T
            *
            * Configure and implement 'LinkStates_' sequence class.
            */
            #define T LinkStates_
            #define TSeq LinkStates_Seq

            #define T_initialize_w_params gazebo_msgs::msg::dds_::LinkStates__initialize_w_params

            #define T_finalize_w_params   gazebo_msgs::msg::dds_::LinkStates__finalize_w_params
            #define T_copy       gazebo_msgs::msg::dds_::LinkStates__copy
