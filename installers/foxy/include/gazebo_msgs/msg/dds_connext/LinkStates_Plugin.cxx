    ...
    namespace msg {
        namespace dds_ {
            ...
            * -------------------------------------------------------------------------- */
            ...
            {
                LinkStates_ *sample = NULL;

                sample = new (std::nothrow) LinkStates_ ;
                if (sample == NULL) {
                    return NULL;
                }

                if (!gazebo_msgs::msg::dds_::LinkStates__initialize_w_params(sample,alloc_params)) {
                    delete  sample;
                    sample=NULL;
                }
                return sample; 
            ...
            LinkStates_PluginSupport_create_data_ex(RTIBool allocate_pointers) 
            {
                ...
                if (!gazebo_msgs::msg::dds_::LinkStates__initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                    delete  sample;
                    sample=NULL;
                }
            ...
            {
                return gazebo_msgs::msg::dds_::LinkStates_PluginSupport_create_data_ex(RTI_TRUE);
            }
            ...
            LinkStates_PluginSupport_destroy_data_w_params(
                ...
                gazebo_msgs::msg::dds_::LinkStates__finalize_w_params(sample,dealloc_params);
            ...
            LinkStates_PluginSupport_destroy_data_ex(
                ...
                gazebo_msgs::msg::dds_::LinkStates__finalize_ex(sample,deallocate_pointers);
            ...
            LinkStates_PluginSupport_destroy_data(
                ...
                gazebo_msgs::msg::dds_::LinkStates_PluginSupport_destroy_data_ex(sample,RTI_TRUE);
            ...
            {
                return gazebo_msgs::msg::dds_::LinkStates__copy(dst,(const LinkStates_*) src);
            }
            ...
            * ---------------------------------------------------------------------------- */
                ...
                void *containerPluginContext)
            {
                ...
                epd = PRESTypePluginDefaultEndpointData_new(
                    ...
                    gazebo_msgs::msg::dds_::LinkStates_PluginSupport_create_data,
                    (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
                    gazebo_msgs::msg::dds_::LinkStates_PluginSupport_destroy_data,
                    NULL , NULL );
                ...
                if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                    serializedSampleMaxSize = gazebo_msgs::msg::dds_::LinkStates_Plugin_get_serialized_sample_max_size(
                    ...
                    if (PRESTypePluginDefaultEndpointData_createWriterPool(
                        ...
                        gazebo_msgs::msg::dds_::LinkStates_Plugin_get_serialized_sample_max_size, epd,
                        (PRESTypePluginGetSerializedSampleSizeFunction)
                        gazebo_msgs::msg::dds_::LinkStates_Plugin_get_serialized_sample_size,
                        epd) == RTI_FALSE) {
                ...
                void *handle)
            {
                ...
                LinkStates__finalize_optional_members(sample, RTI_TRUE);
                ...
                const LinkStates_ *src)
            {
                ...
                return gazebo_msgs::msg::dds_::LinkStates_PluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                try {
                    ...
                    if(deserialize_sample) {
                        ...
                        gazebo_msgs::msg::dds_::LinkStates__initialize_ex(sample, RTI_FALSE, RTI_FALSE);
                ...
                const LinkStates_ *sample)
            {
                ...
                result = gazebo_msgs::msg::dds_::LinkStates_Plugin_serialize(
                ...
                unsigned int length)
            {
                ...
                LinkStates__finalize_optional_members(sample, RTI_TRUE);
                return LinkStates_Plugin_deserialize_sample( 
                    NULL, sample,
                ...
                const struct DDS_PrintFormatProperty *property)
            {
                ...
                if (!LinkStates_Plugin_serialize_to_cdr_buffer(
                    NULL, 
                    &length, 
                    sample)) {
                ...
                void *endpoint_plugin_qos)
            {
                ...
                RTIBool result;
                const char *METHOD_NAME = "LinkStates_Plugin_deserialize";
                if (drop_sample) {} /* To avoid warnings */

                stream->_xTypesState.unassignable = RTI_FALSE;
                result= gazebo_msgs::msg::dds_::LinkStates_Plugin_deserialize_sample( 
            ...
            RTIBool LinkStates_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream,   
                ...
                unsigned int current_alignment)
            {
                ...
                size = LinkStates_Plugin_get_serialized_sample_max_size_ex(
            ...
            * -------------------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if(serialize_key) {
                    ...
                    if (!gazebo_msgs::msg::dds_::LinkStates_Plugin_serialize(
                        endpoint_data,
                        sample,
                        stream,
                        RTI_FALSE, encapsulation_id,
            ...
            RTIBool LinkStates_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                LinkStates_ *sample, 
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
                ...
                void *endpoint_plugin_qos)
            {
                try {
                    ...
                    if (deserialize_key) {
                        ...
                        if (!gazebo_msgs::msg::dds_::LinkStates_Plugin_deserialize_sample(
            ...
            RTIBool LinkStates_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                LinkStates_ **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if (drop_sample) {} /* To avoid warnings */
                stream->_xTypesState.unassignable = RTI_FALSE;
                result= gazebo_msgs::msg::dds_::LinkStates_Plugin_deserialize_key_sample(
                ...
                unsigned int current_alignment)
            {
                ...
                current_alignment += gazebo_msgs::msg::dds_::LinkStates_Plugin_get_serialized_sample_max_size_ex(
                ...
                unsigned int current_alignment)
            {
                ...
                size = LinkStates_Plugin_get_serialized_key_max_size_ex(
                    endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
            ...
            * ------------------------------------------------------------------------ */
            struct PRESTypePlugin *LinkStates_Plugin_new(void) 
            { 
                ...
                gazebo_msgs::msg::dds_::LinkStates_Plugin_on_participant_attached;
                plugin->onParticipantDetached =
                (PRESTypePluginOnParticipantDetachedCallback)
                gazebo_msgs::msg::dds_::LinkStates_Plugin_on_participant_detached;
                plugin->onEndpointAttached =
                (PRESTypePluginOnEndpointAttachedCallback)
                gazebo_msgs::msg::dds_::LinkStates_Plugin_on_endpoint_attached;
                plugin->onEndpointDetached =
                (PRESTypePluginOnEndpointDetachedCallback)
                gazebo_msgs::msg::dds_::LinkStates_Plugin_on_endpoint_detached;

                plugin->copySampleFnc =
                (PRESTypePluginCopySampleFunction)
                gazebo_msgs::msg::dds_::LinkStates_Plugin_copy_sample;
                plugin->createSampleFnc =
                (PRESTypePluginCreateSampleFunction)
                LinkStates_Plugin_create_sample;
                plugin->destroySampleFnc =
                (PRESTypePluginDestroySampleFunction)
                LinkStates_Plugin_destroy_sample;
                plugin->finalizeOptionalMembersFnc =
                (PRESTypePluginFinalizeOptionalMembersFunction)
                LinkStates__finalize_optional_members;

                plugin->serializeFnc =
                (PRESTypePluginSerializeFunction)
                gazebo_msgs::msg::dds_::LinkStates_Plugin_serialize;
                plugin->deserializeFnc =
                (PRESTypePluginDeserializeFunction)
                gazebo_msgs::msg::dds_::LinkStates_Plugin_deserialize;
                plugin->getSerializedSampleMaxSizeFnc =
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                gazebo_msgs::msg::dds_::LinkStates_Plugin_get_serialized_sample_max_size;
                plugin->getSerializedSampleMinSizeFnc =
                (PRESTypePluginGetSerializedSampleMinSizeFunction)
                gazebo_msgs::msg::dds_::LinkStates_Plugin_get_serialized_sample_min_size;

                plugin->getSampleFnc =
                (PRESTypePluginGetSampleFunction)
                LinkStates_Plugin_get_sample;
                ...
                gazebo_msgs::msg::dds_::LinkStates_Plugin_get_key_kind;
                ...
                */
                ...
                plugin->typeCode =  (struct RTICdrTypeCode *)gazebo_msgs::msg::dds_::LinkStates__get_typecode();
                ...
                LinkStates_Plugin_get_buffer;
                plugin->returnBuffer = 
                (PRESTypePluginReturnBufferFunction)
                LinkStates_Plugin_return_buffer;
                plugin->getSerializedSampleSizeFnc =
                (PRESTypePluginGetSerializedSampleSizeFunction)
                gazebo_msgs::msg::dds_::LinkStates_Plugin_get_serialized_sample_size;

                plugin->endpointTypeName = LinkStates_TYPENAME;

                return plugin;
            }

            void
            LinkStates_Plugin_delete(struct PRESTypePlugin *plugin)
            {
