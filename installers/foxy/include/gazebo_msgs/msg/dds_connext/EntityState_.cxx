...
namespace gazebo_msgs {
    namespace msg {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *EntityState_TYPENAME = "gazebo_msgs::msg::dds_::EntityState_";
            ...
            DDS_TypeCode* EntityState__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"gazebo_msgs::msg::dds_::EntityState_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool EntityState__initialize(
                EntityState_* sample) {
                return gazebo_msgs::msg::dds_::EntityState__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                EntityState_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return gazebo_msgs::msg::dds_::EntityState__initialize_w_params(
                    sample,&allocParams);
                ...
                EntityState_* sample)
            {
                ...
                gazebo_msgs::msg::dds_::EntityState__finalize_ex(sample,RTI_TRUE);
            }
                ...
                EntityState_* sample,RTIBool deletePointers)
            {
                ...
                gazebo_msgs::msg::dds_::EntityState__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params gazebo_msgs::msg::dds_::EntityState__initialize_w_params

            #define T_finalize_w_params   gazebo_msgs::msg::dds_::EntityState__finalize_w_params
            #define T_copy       gazebo_msgs::msg::dds_::EntityState__copy
