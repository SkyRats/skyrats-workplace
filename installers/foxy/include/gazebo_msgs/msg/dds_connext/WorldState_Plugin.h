...
#ifndef WorldState_Plugin_2139257776_h
#define WorldState_Plugin_2139257776_h
...
namespace gazebo_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define WorldState_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define WorldState_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define WorldState_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define WorldState_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define WorldState_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern WorldState_*
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            WorldState_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                WorldState_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            WorldState_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                WorldState_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            WorldState_Plugin_new(void);

            NDDSUSERDllExport extern void
            WorldState_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* WorldState_Plugin_2139257776_h */
