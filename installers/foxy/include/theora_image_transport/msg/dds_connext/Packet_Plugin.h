...
#ifndef Packet_Plugin_2097600945_h
#define Packet_Plugin_2097600945_h
...
namespace theora_image_transport {
    namespace msg {
        namespace dds_ {
            ...
            #define Packet_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define Packet_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define Packet_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define Packet_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define Packet_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern Packet_*
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            Packet_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                Packet_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            Packet_Plugin_new(void);

            NDDSUSERDllExport extern void
            Packet_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* Packet_Plugin_2097600945_h */
