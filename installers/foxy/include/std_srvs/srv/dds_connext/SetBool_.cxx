...
namespace std_srvs {
    namespace srv {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *SetBool_Request_TYPENAME = "std_srvs::srv::dds_::SetBool_Request_";
            ...
            DDS_TypeCode* SetBool_Request__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"std_srvs::srv::dds_::SetBool_Request_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool SetBool_Request__initialize(
                ...
                return std_srvs::srv::dds_::SetBool_Request__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                SetBool_Request_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return std_srvs::srv::dds_::SetBool_Request__initialize_w_params(
                    sample,&allocParams);
                ...
                SetBool_Request_* sample)
            {
                ...
                std_srvs::srv::dds_::SetBool_Request__finalize_ex(sample,RTI_TRUE);
            }
                ...
                SetBool_Request_* sample,RTIBool deletePointers)
            {
                ...
                std_srvs::srv::dds_::SetBool_Request__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params std_srvs::srv::dds_::SetBool_Request__initialize_w_params

            #define T_finalize_w_params   std_srvs::srv::dds_::SetBool_Request__finalize_w_params
            #define T_copy       std_srvs::srv::dds_::SetBool_Request__copy
...
namespace std_srvs {
    namespace srv {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *SetBool_Response_TYPENAME = "std_srvs::srv::dds_::SetBool_Response_";
            ...
            DDS_TypeCode* SetBool_Response__get_typecode()
            {
                ...
                {{
                        ...
                        DDS_BOOLEAN_FALSE, /* Ignored */
                        -1, /*Ignored*/
                        (char *)"std_srvs::srv::dds_::SetBool_Response_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool SetBool_Response__initialize(
                ...
                return std_srvs::srv::dds_::SetBool_Response__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                SetBool_Response_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return std_srvs::srv::dds_::SetBool_Response__initialize_w_params(
                    sample,&allocParams);
                ...
                SetBool_Response_* sample)
            {
                ...
                std_srvs::srv::dds_::SetBool_Response__finalize_ex(sample,RTI_TRUE);
            }
                ...
                SetBool_Response_* sample,RTIBool deletePointers)
            {
                ...
                std_srvs::srv::dds_::SetBool_Response__finalize_w_params(
                    sample,&deallocParams);
            }
            ...
            */
            ...
            #define T_initialize_w_params std_srvs::srv::dds_::SetBool_Response__initialize_w_params

            #define T_finalize_w_params   std_srvs::srv::dds_::SetBool_Response__finalize_w_params
            #define T_copy       std_srvs::srv::dds_::SetBool_Response__copy
