...
namespace std_srvs {
    namespace srv {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *Trigger_Request_TYPENAME = "std_srvs::srv::dds_::Trigger_Request_";
            ...
            DDS_TypeCode* Trigger_Request__get_typecode()
            {
                ...
                {{
                        ...
                        -1, /*Ignored*/
                        (char *)"std_srvs::srv::dds_::Trigger_Request_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool Trigger_Request__initialize(
                ...
                return std_srvs::srv::dds_::Trigger_Request__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                Trigger_Request_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return std_srvs::srv::dds_::Trigger_Request__initialize_w_params(
                    sample,&allocParams);
                ...
                Trigger_Request_* sample)
            {
                ...
                std_srvs::srv::dds_::Trigger_Request__finalize_ex(sample,RTI_TRUE);
            }
                ...
                Trigger_Request_* sample,RTIBool deletePointers)
            {
                ...
                std_srvs::srv::dds_::Trigger_Request__finalize_w_params(
            ...
            */
            ...
            #define T_initialize_w_params std_srvs::srv::dds_::Trigger_Request__initialize_w_params

            #define T_finalize_w_params   std_srvs::srv::dds_::Trigger_Request__finalize_w_params
            #define T_copy       std_srvs::srv::dds_::Trigger_Request__copy
...
namespace std_srvs {
    namespace srv {
        namespace dds_ {
            ...
            /* ========================================================================= */
            const char *Trigger_Response_TYPENAME = "std_srvs::srv::dds_::Trigger_Response_";
            ...
            DDS_TypeCode* Trigger_Response__get_typecode()
            {
                ...
                {{
                        ...
                        DDS_BOOLEAN_FALSE, /* Ignored */
                        -1, /*Ignored*/
                        (char *)"std_srvs::srv::dds_::Trigger_Response_", /* Name */
                        NULL, /* Ignored */      
                        0, /* Ignored */
                        0, /* Ignored */
                        NULL, /* Ignored */
            ...
            RTIBool Trigger_Response__initialize(
                ...
                return std_srvs::srv::dds_::Trigger_Response__initialize_ex(sample,RTI_TRUE,RTI_TRUE);
            }
                ...
                Trigger_Response_* sample,RTIBool allocatePointers, RTIBool allocateMemory)
            {
                ...
                return std_srvs::srv::dds_::Trigger_Response__initialize_w_params(
                    sample,&allocParams);
                ...
                Trigger_Response_* sample)
            {
                ...
                std_srvs::srv::dds_::Trigger_Response__finalize_ex(sample,RTI_TRUE);
            }
                ...
                Trigger_Response_* sample,RTIBool deletePointers)
            {
                ...
                std_srvs::srv::dds_::Trigger_Response__finalize_w_params(
                    sample,&deallocParams);
            }
            ...
            */
            ...
            #define T_initialize_w_params std_srvs::srv::dds_::Trigger_Response__initialize_w_params

            #define T_finalize_w_params   std_srvs::srv::dds_::Trigger_Response__finalize_w_params
            #define T_copy       std_srvs::srv::dds_::Trigger_Response__copy
