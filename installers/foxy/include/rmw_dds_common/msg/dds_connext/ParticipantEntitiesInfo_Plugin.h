...
#ifndef ParticipantEntitiesInfo_Plugin_569828908_h
#define ParticipantEntitiesInfo_Plugin_569828908_h
...
namespace rmw_dds_common {
    namespace msg {
        namespace dds_ {
            ...
            #define ParticipantEntitiesInfo_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define ParticipantEntitiesInfo_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define ParticipantEntitiesInfo_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define ParticipantEntitiesInfo_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define ParticipantEntitiesInfo_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern ParticipantEntitiesInfo_*
            ...
            ParticipantEntitiesInfo_PluginSupport_copy_data(
                ParticipantEntitiesInfo_ *out,
                const ParticipantEntitiesInfo_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            ParticipantEntitiesInfo_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            ParticipantEntitiesInfo_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                ParticipantEntitiesInfo_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            ParticipantEntitiesInfo_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ParticipantEntitiesInfo_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            ParticipantEntitiesInfo_Plugin_new(void);

            NDDSUSERDllExport extern void
            ParticipantEntitiesInfo_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* ParticipantEntitiesInfo_Plugin_569828908_h */
