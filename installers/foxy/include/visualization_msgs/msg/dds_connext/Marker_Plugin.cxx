        ...
        namespace dds_ {
            ...
            * -------------------------------------------------------------------------- */
                ...
                const struct DDS_TypeAllocationParams_t * alloc_params) 
            {
                ...
                sample = new (std::nothrow) Marker_ ;
                if (sample == NULL) {
                    return NULL;
                }

                if (!visualization_msgs::msg::dds_::Marker__initialize_w_params(sample,alloc_params)) {
                    delete  sample;
                    sample=NULL;
                }
                return sample; 
            ...
            Marker_PluginSupport_create_data_ex(RTIBool allocate_pointers) 
            {
                ...
                if (!visualization_msgs::msg::dds_::Marker__initialize_ex(sample,allocate_pointers, RTI_TRUE)) {
                    delete  sample;
                    sample=NULL;
                }
            ...
            {
                return visualization_msgs::msg::dds_::Marker_PluginSupport_create_data_ex(RTI_TRUE);
            }
            ...
            Marker_PluginSupport_destroy_data_w_params(
                ...
                visualization_msgs::msg::dds_::Marker__finalize_w_params(sample,dealloc_params);
            ...
            Marker_PluginSupport_destroy_data_ex(
                ...
                visualization_msgs::msg::dds_::Marker__finalize_ex(sample,deallocate_pointers);
            ...
            Marker_PluginSupport_destroy_data(
                ...
                visualization_msgs::msg::dds_::Marker_PluginSupport_destroy_data_ex(sample,RTI_TRUE);
            ...
            Marker_PluginSupport_copy_data(
                ...
                const Marker_ *src)
            {
                return visualization_msgs::msg::dds_::Marker__copy(dst,(const Marker_*) src);
            }
                ...
                unsigned int indent_level)
            {
                ...
                geometry_msgs::msg::dds_::Vector3_PluginSupport_print_data(
                    (const geometry_msgs::msg::dds_::Vector3_*) &sample->scale_, "scale_", indent_level + 1);

                std_msgs::msg::dds_::ColorRGBA_PluginSupport_print_data(
                    (const std_msgs::msg::dds_::ColorRGBA_*) &sample->color_, "color_", indent_level + 1);
                ...
                RTICdrType_printBoolean(
                    &sample->frame_locked_, "frame_locked_", indent_level + 1);    
                ...
                if (std_msgs::msg::dds_::ColorRGBA_Seq_get_contiguous_bufferI(&sample->colors_) != NULL) {
                    RTICdrType_printArray(
                        std_msgs::msg::dds_::ColorRGBA_Seq_get_contiguous_bufferI(&sample->colors_), 
                        std_msgs::msg::dds_::ColorRGBA_Seq_get_length(&sample->colors_),
                        sizeof(std_msgs::msg::dds_::ColorRGBA_),
                        (RTICdrTypePrintFunction)std_msgs::msg::dds_::ColorRGBA_PluginSupport_print_data,
                        "colors_", indent_level + 1);
                } else {
                    RTICdrType_printPointerArray(
                        std_msgs::msg::dds_::ColorRGBA_Seq_get_discontiguous_bufferI(&sample->colors_), 
                        std_msgs::msg::dds_::ColorRGBA_Seq_get_length(&sample->colors_),
                        (RTICdrTypePrintFunction)std_msgs::msg::dds_::ColorRGBA_PluginSupport_print_data,
                        "colors_", indent_level + 1);
                }
                ...
                if (sample->mesh_resource_==NULL) {
                    RTICdrType_printString(
                        NULL,"mesh_resource_", indent_level + 1);
                } else {
                    RTICdrType_printString(
                        sample->mesh_resource_,"mesh_resource_", indent_level + 1);    
                }

                RTICdrType_printBoolean(
                    &sample->mesh_use_embedded_materials_, "mesh_use_embedded_materials_", indent_level + 1);    
            ...
            * ---------------------------------------------------------------------------- */
                ...
                void *containerPluginContext)
            {
                ...
                epd = PRESTypePluginDefaultEndpointData_new(
                    ...
                    visualization_msgs::msg::dds_::Marker_PluginSupport_create_data,
                    (PRESTypePluginDefaultEndpointDataDestroySampleFunction)
                    visualization_msgs::msg::dds_::Marker_PluginSupport_destroy_data,
                    NULL , NULL );
                ...
                if (endpoint_info->endpointKind == PRES_TYPEPLUGIN_ENDPOINT_WRITER) {
                    serializedSampleMaxSize = visualization_msgs::msg::dds_::Marker_Plugin_get_serialized_sample_max_size(
                    ...
                    if (PRESTypePluginDefaultEndpointData_createWriterPool(
                        ...
                        visualization_msgs::msg::dds_::Marker_Plugin_get_serialized_sample_max_size, epd,
                        (PRESTypePluginGetSerializedSampleSizeFunction)
                        visualization_msgs::msg::dds_::Marker_Plugin_get_serialized_sample_size,
                        epd) == RTI_FALSE) {
                ...
                void *handle)
            {
                ...
                Marker__finalize_optional_members(sample, RTI_TRUE);
                ...
                const Marker_ *src)
            {
                ...
                return visualization_msgs::msg::dds_::Marker_PluginSupport_copy_data(dst,src);
            }
            ...
            * ------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if(serialize_sample) {
                    ...
                    if(!geometry_msgs::msg::dds_::Vector3_Plugin_serialize(
                        endpoint_data,
                        (const geometry_msgs::msg::dds_::Vector3_*) &sample->scale_,
                        stream,
                        RTI_FALSE, encapsulation_id,
                        RTI_TRUE,
                        endpoint_plugin_qos)) {
                    ...
                    if(!std_msgs::msg::dds_::ColorRGBA_Plugin_serialize(
                        endpoint_data,
                        (const std_msgs::msg::dds_::ColorRGBA_*) &sample->color_,
                        stream,
                        RTI_FALSE, encapsulation_id,
                        RTI_TRUE,
                        endpoint_plugin_qos)) {
                    ...
                    if (std_msgs::msg::dds_::ColorRGBA_Seq_get_contiguous_bufferI(&sample->colors_) != NULL) {
                        ...
                        if (!RTICdrStream_serializeNonPrimitivePointerSequence(
                            stream,
                            (const void **) std_msgs::msg::dds_::ColorRGBA_Seq_get_discontiguous_bufferI(&sample->colors_),
                            std_msgs::msg::dds_::ColorRGBA_Seq_get_length(&sample->colors_),
                            (RTI_INT32_MAX-1),
                            (RTICdrStreamSerializeFunction)std_msgs::msg::dds_::ColorRGBA_Plugin_serialize,
                            RTI_FALSE, encapsulation_id,RTI_TRUE,
                    ...
                    if (!RTICdrStream_serializeString(
                        stream, sample->mesh_resource_, (RTI_INT32_MAX-1) + 1)) {
                        return RTI_FALSE;
                    }

                    if (!RTICdrStream_serializeBoolean(
                        stream, &sample->mesh_use_embedded_materials_)) {
                        return RTI_FALSE;
                    }
                ...
                void *endpoint_plugin_qos)
            {
                ...
                try {
                    ...
                    if(deserialize_sample) {
                        ...
                        visualization_msgs::msg::dds_::Marker__initialize_ex(sample, RTI_FALSE, RTI_FALSE);
                        ...
                        }
                        {
                            ...
                            if (!std_msgs::msg::dds_::ColorRGBA_Seq_set_maximum(&sample->colors_,sequence_length)) {
                                return RTI_FALSE;
                            }
                            if (std_msgs::msg::dds_::ColorRGBA_Seq_get_contiguous_bufferI(&sample->colors_) != NULL) {
                                if (!RTICdrStream_deserializeNonPrimitiveSequence(
                                    ...
                                    std_msgs::msg::dds_::ColorRGBA_Seq_get_contiguous_bufferI(&sample->colors_),
                                    &sequence_length,
                                    std_msgs::msg::dds_::ColorRGBA_Seq_get_maximum(&sample->colors_),
                                    sizeof(std_msgs::msg::dds_::ColorRGBA_),
                                ...
                                if (!RTICdrStream_deserializeNonPrimitivePointerSequence(
                                    stream,
                                    (void **) std_msgs::msg::dds_::ColorRGBA_Seq_get_discontiguous_bufferI(&sample->colors_),
                                    &sequence_length,
                                    std_msgs::msg::dds_::ColorRGBA_Seq_get_maximum(&sample->colors_),
                                    (RTICdrStreamDeserializeFunction)std_msgs::msg::dds_::ColorRGBA_Plugin_deserialize_sample,
                                    RTI_FALSE,RTI_TRUE,
                            ...
                            if (!std_msgs::msg::dds_::ColorRGBA_Seq_set_length(
                                &sample->colors_,sequence_length)) {
                                return RTI_FALSE;
                            }        
                        ...
                        if (!RTICdrStream_deserializeStringEx(
                            stream,&sample->mesh_resource_, (RTI_INT32_MAX-1) + 1,RTI_TRUE)) {
                            goto fin; 
                        }
                        if (!RTICdrStream_deserializeBoolean(
                            stream, &sample->mesh_use_embedded_materials_)) {
                ...
                const Marker_ *sample)
            {
                ...
                result = visualization_msgs::msg::dds_::Marker_Plugin_serialize(
                ...
                unsigned int length)
            {
                ...
                Marker__finalize_optional_members(sample, RTI_TRUE);
                return Marker_Plugin_deserialize_sample( 
                    NULL, sample,
                ...
                const struct DDS_PrintFormatProperty *property)
            {
                ...
                if (!Marker_Plugin_serialize_to_cdr_buffer(
                    NULL, 
                    &length, 
                    sample)) {
                ...
                void *endpoint_plugin_qos)
            {
                ...
                RTIBool result;
                const char *METHOD_NAME = "Marker_Plugin_deserialize";
                if (drop_sample) {} /* To avoid warnings */

                stream->_xTypesState.unassignable = RTI_FALSE;
                result= visualization_msgs::msg::dds_::Marker_Plugin_deserialize_sample( 
                ...
                unsigned int current_alignment)
            {
                ...
                size = Marker_Plugin_get_serialized_sample_max_size_ex(
            ...
            */
                ...
                const Marker_ * sample) 
            {
                ...
                current_alignment += geometry_msgs::msg::dds_::Vector3_Plugin_get_serialized_sample_size(
                    endpoint_data,RTI_FALSE, encapsulation_id,
                    current_alignment, (const geometry_msgs::msg::dds_::Vector3_*) &sample->scale_);

                current_alignment += std_msgs::msg::dds_::ColorRGBA_Plugin_get_serialized_sample_size(
                    endpoint_data,RTI_FALSE, encapsulation_id,
                    current_alignment, (const std_msgs::msg::dds_::ColorRGBA_*) &sample->color_);
                ...
                if (std_msgs::msg::dds_::ColorRGBA_Seq_get_contiguous_bufferI(&sample->colors_) != NULL) {
                    current_alignment += RTICdrType_getNonPrimitiveArraySerializedSize(
                        current_alignment, std_msgs::msg::dds_::ColorRGBA_Seq_get_length(&sample->colors_),
                        sizeof(std_msgs::msg::dds_::ColorRGBA_),
                ...
                current_alignment += RTICdrType_getStringSerializedSize(
                    PRESTypePluginDefaultEndpointData_getAlignment(
                        endpoint_data, current_alignment), sample->mesh_resource_);
            ...
            * -------------------------------------------------------------------------------------- */
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if(serialize_key) {
                    ...
                    if (!visualization_msgs::msg::dds_::Marker_Plugin_serialize(
                        endpoint_data,
                        sample,
                        stream,
                        RTI_FALSE, encapsulation_id,
            ...
            RTIBool Marker_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                Marker_ *sample, 
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
                ...
                void *endpoint_plugin_qos)
            {
                try {
                    ...
                    if (deserialize_key) {
                        ...
                        if (!visualization_msgs::msg::dds_::Marker_Plugin_deserialize_sample(
            ...
            RTIBool Marker_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                Marker_ **sample, 
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
                ...
                void *endpoint_plugin_qos)
            {
                ...
                if (drop_sample) {} /* To avoid warnings */
                stream->_xTypesState.unassignable = RTI_FALSE;
                result= visualization_msgs::msg::dds_::Marker_Plugin_deserialize_key_sample(
                ...
                unsigned int current_alignment)
            {
                ...
                current_alignment += visualization_msgs::msg::dds_::Marker_Plugin_get_serialized_sample_max_size_ex(
                ...
                unsigned int current_alignment)
            {
                ...
                size = Marker_Plugin_get_serialized_key_max_size_ex(
                    endpoint_data,&overflow,include_encapsulation,encapsulation_id,current_alignment);
            ...
            * ------------------------------------------------------------------------ */
            struct PRESTypePlugin *Marker_Plugin_new(void) 
            { 
                ...
                visualization_msgs::msg::dds_::Marker_Plugin_on_participant_attached;
                plugin->onParticipantDetached =
                (PRESTypePluginOnParticipantDetachedCallback)
                visualization_msgs::msg::dds_::Marker_Plugin_on_participant_detached;
                plugin->onEndpointAttached =
                (PRESTypePluginOnEndpointAttachedCallback)
                visualization_msgs::msg::dds_::Marker_Plugin_on_endpoint_attached;
                plugin->onEndpointDetached =
                (PRESTypePluginOnEndpointDetachedCallback)
                visualization_msgs::msg::dds_::Marker_Plugin_on_endpoint_detached;

                plugin->copySampleFnc =
                (PRESTypePluginCopySampleFunction)
                visualization_msgs::msg::dds_::Marker_Plugin_copy_sample;
                plugin->createSampleFnc =
                (PRESTypePluginCreateSampleFunction)
                Marker_Plugin_create_sample;
                plugin->destroySampleFnc =
                (PRESTypePluginDestroySampleFunction)
                Marker_Plugin_destroy_sample;
                plugin->finalizeOptionalMembersFnc =
                (PRESTypePluginFinalizeOptionalMembersFunction)
                Marker__finalize_optional_members;

                plugin->serializeFnc =
                (PRESTypePluginSerializeFunction)
                visualization_msgs::msg::dds_::Marker_Plugin_serialize;
                plugin->deserializeFnc =
                (PRESTypePluginDeserializeFunction)
                visualization_msgs::msg::dds_::Marker_Plugin_deserialize;
                plugin->getSerializedSampleMaxSizeFnc =
                (PRESTypePluginGetSerializedSampleMaxSizeFunction)
                visualization_msgs::msg::dds_::Marker_Plugin_get_serialized_sample_max_size;
                ...
                visualization_msgs::msg::dds_::Marker_Plugin_get_key_kind;
                ...
                */
                ...
                plugin->typeCode =  (struct RTICdrTypeCode *)visualization_msgs::msg::dds_::Marker__get_typecode();
                ...
                Marker_Plugin_get_buffer;
                plugin->returnBuffer = 
                (PRESTypePluginReturnBufferFunction)
                Marker_Plugin_return_buffer;
                plugin->getSerializedSampleSizeFnc =
                (PRESTypePluginGetSerializedSampleSizeFunction)
                visualization_msgs::msg::dds_::Marker_Plugin_get_serialized_sample_size;

                plugin->endpointTypeName = Marker_TYPENAME;

                return plugin;
            }

            void
            Marker_Plugin_delete(struct PRESTypePlugin *plugin)
            {
