...
#ifndef InteractiveMarkerInit_Plugin_25285186_h
#define InteractiveMarkerInit_Plugin_25285186_h
...
namespace visualization_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define InteractiveMarkerInit_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define InteractiveMarkerInit_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define InteractiveMarkerInit_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define InteractiveMarkerInit_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define InteractiveMarkerInit_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern InteractiveMarkerInit_*
            ...
            InteractiveMarkerInit_PluginSupport_copy_data(
                InteractiveMarkerInit_ *out,
                const InteractiveMarkerInit_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            InteractiveMarkerInit_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            InteractiveMarkerInit_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                InteractiveMarkerInit_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            InteractiveMarkerInit_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                InteractiveMarkerInit_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            InteractiveMarkerInit_Plugin_new(void);

            NDDSUSERDllExport extern void
            InteractiveMarkerInit_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* InteractiveMarkerInit_Plugin_25285186_h */
