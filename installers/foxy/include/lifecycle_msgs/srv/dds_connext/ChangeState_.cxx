    ...
    namespace srv {
        namespace dds_ {
            ...
            DDS_TypeCode* ChangeState_Request__get_typecode()
            {
                ...
                static DDS_TypeCode_Member ChangeState_Request__g_tc_members[1]=
                {
                ...
                ChangeState_Request__g_tc_members[0]._representation._typeCode = (RTICdrTypeCode *)lifecycle_msgs::msg::dds_::Transition__get_typecode();
