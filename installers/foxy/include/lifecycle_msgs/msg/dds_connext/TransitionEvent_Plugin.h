...
#ifndef TransitionEvent_Plugin_413790389_h
#define TransitionEvent_Plugin_413790389_h
...
namespace lifecycle_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define TransitionEvent_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define TransitionEvent_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define TransitionEvent_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define TransitionEvent_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define TransitionEvent_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern TransitionEvent_*
            ...
            TransitionEvent_PluginSupport_copy_data(
                TransitionEvent_ *out,
                const TransitionEvent_ *in);
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            TransitionEvent_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                TransitionEvent_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            TransitionEvent_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                TransitionEvent_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            TransitionEvent_Plugin_new(void);

            NDDSUSERDllExport extern void
            TransitionEvent_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* TransitionEvent_Plugin_413790389_h */
