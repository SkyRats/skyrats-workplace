...
#ifndef UnloadNode_Plugin_1122133648_h
#define UnloadNode_Plugin_1122133648_h
...
namespace composition_interfaces {
    namespace srv {
        namespace dds_ {
            ...
            #define UnloadNode_Request_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define UnloadNode_Request_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define UnloadNode_Request_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define UnloadNode_Request_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define UnloadNode_Request_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern UnloadNode_Request_*
            ...
            UnloadNode_Request_PluginSupport_copy_data(
                UnloadNode_Request_ *out,
                const UnloadNode_Request_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            UnloadNode_Request_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            UnloadNode_Request_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                UnloadNode_Request_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            UnloadNode_Request_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                UnloadNode_Request_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            UnloadNode_Request_Plugin_new(void);

            NDDSUSERDllExport extern void
            UnloadNode_Request_Plugin_delete(struct PRESTypePlugin *);
...
namespace composition_interfaces {
    namespace srv {
        namespace dds_ {
            ...
            #define UnloadNode_Response_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define UnloadNode_Response_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define UnloadNode_Response_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define UnloadNode_Response_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define UnloadNode_Response_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern UnloadNode_Response_*
            ...
            UnloadNode_Response_PluginSupport_copy_data(
                UnloadNode_Response_ *out,
                const UnloadNode_Response_ *in);
            ...
            * ------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool
            UnloadNode_Response_Plugin_skip(
                PRESTypePluginEndpointData endpoint_data,
                struct RTICdrStream *stream, 
                RTIBool skip_encapsulation,  
                RTIBool skip_sample, 
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            UnloadNode_Response_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                UnloadNode_Response_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            UnloadNode_Response_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                UnloadNode_Response_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            /* Plugin Functions */
            NDDSUSERDllExport extern struct PRESTypePlugin*
            UnloadNode_Response_Plugin_new(void);

            NDDSUSERDllExport extern void
            UnloadNode_Response_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* UnloadNode_Plugin_1122133648_h */
