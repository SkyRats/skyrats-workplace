...
#ifndef ProjectedMapInfo_Plugin_279083632_h
#define ProjectedMapInfo_Plugin_279083632_h
...
namespace map_msgs {
    namespace msg {
        namespace dds_ {
            ...
            #define ProjectedMapInfo_Plugin_get_sample PRESTypePluginDefaultEndpointData_getSample 
            #define ProjectedMapInfo_Plugin_get_buffer PRESTypePluginDefaultEndpointData_getBuffer 
            #define ProjectedMapInfo_Plugin_return_buffer PRESTypePluginDefaultEndpointData_returnBuffer 

            #define ProjectedMapInfo_Plugin_create_sample PRESTypePluginDefaultEndpointData_createSample 
            #define ProjectedMapInfo_Plugin_destroy_sample PRESTypePluginDefaultEndpointData_deleteSample 

            /* --------------------------------------------------------------------------------------
            Support functions:
            * -------------------------------------------------------------------------------------- */

            NDDSUSERDllExport extern ProjectedMapInfo_*
            ...
            ProjectedMapInfo_PluginSupport_copy_data(
                ProjectedMapInfo_ *out,
                const ProjectedMapInfo_ *in);
            ...
            * -------------------------------------------------------------------------------------- */
            ...
            NDDSUSERDllExport extern RTIBool 
            ProjectedMapInfo_Plugin_deserialize_key_sample(
                PRESTypePluginEndpointData endpoint_data,
                ProjectedMapInfo_ * sample,
                struct RTICdrStream *stream,
                RTIBool deserialize_encapsulation,
            ...
            NDDSUSERDllExport extern RTIBool 
            ProjectedMapInfo_Plugin_deserialize_key(
                PRESTypePluginEndpointData endpoint_data,
                ProjectedMapInfo_ ** sample,
                RTIBool * drop_sample,
                struct RTICdrStream *stream,
            ...
            ProjectedMapInfo_Plugin_new(void);

            NDDSUSERDllExport extern void
            ProjectedMapInfo_Plugin_delete(struct PRESTypePlugin *);
...
#endif /* ProjectedMapInfo_Plugin_279083632_h */
