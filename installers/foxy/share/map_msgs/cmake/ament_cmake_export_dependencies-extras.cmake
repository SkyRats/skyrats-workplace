...
set(_exported_dependencies "nav_msgs;sensor_msgs;std_msgs;nav_msgs;builtin_interfaces;geometry_msgs;std_msgs;sensor_msgs;rosidl_runtime_c;rosidl_typesupport_interface;nav_msgs;builtin_interfaces;geometry_msgs;std_msgs;sensor_msgs;nav_msgs;builtin_interfaces;geometry_msgs;std_msgs;sensor_msgs;rosidl_default_runtime")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(map_msgs_INCLUDE_DIRS "${_include_dirs}")
          endif()
