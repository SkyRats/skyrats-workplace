...
set(_exported_dependencies "rcpputils;rosidl_runtime_c;rosidl_runtime_cpp;rosidl_typesupport_interface;rosidl_typesupport_c")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(rosidl_typesupport_cpp_INCLUDE_DIRS "${_include_dirs}")
          endif()
