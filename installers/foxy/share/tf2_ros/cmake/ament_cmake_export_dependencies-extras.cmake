...
set(_exported_dependencies "builtin_interfaces;geometry_msgs;message_filters;rclcpp;rclcpp_action;tf2;tf2_msgs;rcl_interfaces;rclcpp_components")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(tf2_ros_INCLUDE_DIRS "${_include_dirs}")
          endif()
