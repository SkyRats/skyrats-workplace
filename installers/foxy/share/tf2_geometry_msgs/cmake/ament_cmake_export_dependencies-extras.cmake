...
set(_exported_dependencies "geometry_msgs;orocos_kdl;tf2;tf2_ros;geometry_msgs;orocos_kdl;tf2;tf2_ros")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(tf2_geometry_msgs_INCLUDE_DIRS "${_include_dirs}")
          endif()
