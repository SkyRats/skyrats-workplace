...
set(_exported_dependencies "ament_index_cpp;class_loader;rcutils;rcpputils;tinyxml2_vendor;TinyXML2")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(pluginlib_INCLUDE_DIRS "${_include_dirs}")
          endif()
