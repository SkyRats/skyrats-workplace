...
set(_exported_dependencies "rcutils;rmw;rmw_dds_common;rmw_fastrtps_shared_cpp;rosidl_runtime_c;rosidl_typesupport_fastrtps_c;rosidl_typesupport_fastrtps_cpp")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(rmw_fastrtps_cpp_INCLUDE_DIRS "${_include_dirs}")
          endif()
