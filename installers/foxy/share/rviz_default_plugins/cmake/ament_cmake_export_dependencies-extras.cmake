...
set(_exported_dependencies "rviz_common;geometry_msgs;interactive_markers;laser_geometry;map_msgs;nav_msgs;rclcpp;resource_retriever;rviz_ogre_vendor;tf2;tf2_geometry_msgs;tf2_ros;urdf;visualization_msgs")
    ...
    if(NOT "${${_dep}_TARGETS}" STREQUAL "")
      foreach(_target ${${_dep}_TARGETS})
        ...
        if(TARGET "${_target}")
          ...
          if(_include_dirs)
            list_append_unique(rviz_default_plugins_INCLUDE_DIRS "${_include_dirs}")
          endif()
